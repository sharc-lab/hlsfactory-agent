...
#define _uint1_  unsigned int __attribute__ ((bitwidth(1)))
    ...
    _uint1_ _ssdm_op_CanReadReq(...) SSDM_OP_ATTR;
    _uint1_ _ssdm_op_NbWriteReq(...) SSDM_OP_ATTR;
    _uint1_ _ssdm_op_CanWriteReq(...) SSDM_OP_ATTR;
...
#undef _uint1_
    ...
    void _ssdm_op_PrintNone(...) SSDM_OP_ATTR;
    void _ssdm_op_PrintInt(...) SSDM_OP_ATTR;
    void _ssdm_op_PrintDouble(...) SSDM_OP_ATTR;
...
#undef _uint1_
    ...
    void _ssdm_op_Wait(int) SSDM_OP_ATTR;
    void _ssdm_op_Poll() SSDM_OP_ATTR;
