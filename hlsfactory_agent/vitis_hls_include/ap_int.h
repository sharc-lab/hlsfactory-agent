...
// ===== ap_int =====
template <int _W>
struct numeric_limits<ap_int<_W>> {
    static constexpr bool is_specialized = true;

    AP_INLINE AP_NODEBUG
    static constexpr ap_int<_W> min() noexcept { 
      return ap_int<_W>(1) << (_W - 1); 
    }
    
    AP_INLINE AP_NODEBUG
    static constexpr ap_int<_W> lowest() noexcept { 
      return min(); 
    }
    
    AP_INLINE AP_NODEBUG
    static constexpr ap_int<_W> max() noexcept { 
      return (ap_int<_W>(1) << (_W - 1)) - 1; 
    }

    static constexpr int digits = _W - 1; // one bit for sign
    static constexpr int digits10 = ((_W - 1) * 301) / 1000; // floor((W-1) * log10(2))
    ...
    static constexpr ap_int<_W> epsilon() noexcept { return 0;}
    static constexpr ap_int<_W> round_error() noexcept { return 0;}
};
// ===== ap_uint =====
template <int _W>
struct numeric_limits<ap_uint<_W>> {
    static constexpr bool is_specialized = true;

    static constexpr ap_uint<_W> min() noexcept { return 0; }
    static constexpr ap_uint<_W> lowest() noexcept { return 0; }

    AP_INLINE AP_NODEBUG
    static constexpr ap_uint<_W> max() noexcept { 
      return (ap_uint<_W>(1) << _W) - 1; 
    }

    static constexpr int digits = _W;
    static constexpr int digits10 = (_W * 301) / 1000; // floor(W * log10(2))
    ...
    static constexpr int radix = 2;
    static constexpr ap_uint<_W> epsilon() noexcept { return 0;}
    static constexpr ap_uint<_W> round_error() noexcept { return 0;}
};
