...
public:
    ...
    explicit operator unsigned int() const { return static_cast<unsigned int>(val); }
    explicit operator long() const { return static_cast<long>(val); }
    explicit operator unsigned long() const { return static_cast<unsigned long>(val); }
