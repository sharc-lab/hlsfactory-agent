...
### Function Signature
```cpp
void k_gaussian_quadrature_a( #if BP_BYPASS == 0 REPEAT( ARGS_UBA_IN, BP_FIFO_COUNT )
```
...
```
k_gaussian_quadrature_a/
├── k_gaussian_quadrature_a.cpp          # Kernel source code
├── k_gaussian_quadrature_a_tb.cpp       # Testbench
├── src/                        # Header files
...
```bash
clang++ -c -std=c++17 -I./stubs -I./src/common -I./src/device k_gaussian_quadrature_a.cpp
```
