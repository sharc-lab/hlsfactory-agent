...
def build_prompt(repo_url: str) -> str:
    return (
        ...
        "```\n"
        "clang++ -std=c++17 -I/workspace/stubs -I<design_source_dir> -w -fsyntax-only <file.cpp>\n"
        "```\n"
        "- `-I/workspace/stubs` provides stub headers for ap_int.h, ap_fixed.h, hls_stream.h, tapa.h, hls_math.h, ap_axi_sdata.h\n"
