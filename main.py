...
def build_prompt(repo_url: str) -> str:
    return (
        ...
        "For each design found, create a folder directly under /output/<repo_name>/<design_name>/ containing:\n"
        "- Do NOT create subdirectories like /output/<repo_name>/designs/ — all design folders must be immediate children of /output/<repo_name>/\n"
