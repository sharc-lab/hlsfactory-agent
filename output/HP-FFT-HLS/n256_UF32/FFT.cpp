...
void reverse_input_stream_UF32 (
    ...
    READ_STREAM_INPUT: for (int i = 0; i < TIME_STEP; i++){
        ...
        data_rev_stream[32][(int)reversed[1]% (int)TIME_STEP] = temp[1];
        data_rev_stream[16][(int)reversed[2]% (int)TIME_STEP] = temp[2];
        data_rev_stream[48][(int)reversed[3]% (int)TIME_STEP] = temp[3];
        data_rev_stream[8][reversed[4]% (int)TIME_STEP] = temp[4];
        data_rev_stream[40][reversed[5]% (int)TIME_STEP] = temp[5];
        data_rev_stream[24][reversed[6]% (int)TIME_STEP] = temp[6];
        data_rev_stream[56][reversed[7]% (int)TIME_STEP] = temp[7];
        data_rev_stream[4][reversed[8]% (int)TIME_STEP] = temp[8];
        data_rev_stream[36][reversed[9]% (int)TIME_STEP] = temp[9];
        data_rev_stream[20][reversed[10]% (int)TIME_STEP] = temp[10];
        data_rev_stream[52][reversed[11]% (int)TIME_STEP] = temp[11];
        data_rev_stream[12][reversed[12]% (int)TIME_STEP] = temp[12];
        data_rev_stream[44][reversed[13]% (int)TIME_STEP] = temp[13];
        data_rev_stream[28][reversed[14]% (int)TIME_STEP] = temp[14];
        data_rev_stream[60][reversed[15]% (int)TIME_STEP] = temp[15];
        data_rev_stream[2][reversed[16]% (int)TIME_STEP] = temp[16];
        data_rev_stream[34][reversed[17]% (int)TIME_STEP] = temp[17];
        data_rev_stream[18][reversed[18]% (int)TIME_STEP] = temp[18];
        data_rev_stream[50][reversed[19]% (int)TIME_STEP] = temp[19];
        data_rev_stream[10][reversed[20]% (int)TIME_STEP] = temp[20];
        data_rev_stream[42][reversed[21]% (int)TIME_STEP] = temp[21];
        data_rev_stream[26][reversed[22]% (int)TIME_STEP] = temp[22];
        data_rev_stream[58][reversed[23]% (int)TIME_STEP] = temp[23];
        data_rev_stream[6][reversed[24]% (int)TIME_STEP] = temp[24];
        data_rev_stream[38][reversed[25]% (int)TIME_STEP] = temp[25];
        data_rev_stream[22][reversed[26]% (int)TIME_STEP] = temp[26];
        data_rev_stream[54][reversed[27]% (int)TIME_STEP] = temp[27];
        data_rev_stream[14][reversed[28]% (int)TIME_STEP] = temp[28];
        data_rev_stream[46][reversed[29]% (int)TIME_STEP] = temp[29];
        data_rev_stream[30][reversed[30]% (int)TIME_STEP] = temp[30];
        data_rev_stream[62][reversed[31]% (int)TIME_STEP] = temp[31];
        data_rev_stream[1][reversed[32]% (int)TIME_STEP] = temp[32];
        data_rev_stream[33][reversed[33]% (int)TIME_STEP] = temp[33];
        data_rev_stream[17][reversed[34]% (int)TIME_STEP] = temp[34];
        data_rev_stream[49][reversed[35]% (int)TIME_STEP] = temp[35];
        data_rev_stream[9][reversed[36]% (int)TIME_STEP] = temp[36];
        data_rev_stream[41][reversed[37]% (int)TIME_STEP] = temp[37];
        data_rev_stream[25][reversed[38]% (int)TIME_STEP] = temp[38];
        data_rev_stream[57][reversed[39]% (int)TIME_STEP] = temp[39];
        data_rev_stream[5][reversed[40]% (int)TIME_STEP] = temp[40];
        data_rev_stream[37][reversed[41]% (int)TIME_STEP] = temp[41];
        data_rev_stream[21][reversed[42]% (int)TIME_STEP] = temp[42];
        data_rev_stream[53][reversed[43]% (int)TIME_STEP] = temp[43];
        data_rev_stream[13][reversed[44]% (int)TIME_STEP] = temp[44];
        data_rev_stream[45][reversed[45]% (int)TIME_STEP] = temp[45];
        data_rev_stream[29][reversed[46]% (int)TIME_STEP] = temp[46];
        data_rev_stream[61][reversed[47]% (int)TIME_STEP] = temp[47];
        data_rev_stream[3][reversed[48]% (int)TIME_STEP] = temp[48];
        data_rev_stream[35][reversed[49]% (int)TIME_STEP] = temp[49];
        data_rev_stream[19][reversed[50]% (int)TIME_STEP] = temp[50];
        data_rev_stream[51][reversed[51]% (int)TIME_STEP] = temp[51];
        data_rev_stream[11][reversed[52]% (int)TIME_STEP] = temp[52];
        data_rev_stream[43][reversed[53]% (int)TIME_STEP] = temp[53];
        data_rev_stream[27][reversed[54]% (int)TIME_STEP] = temp[54];
        data_rev_stream[59][reversed[55]% (int)TIME_STEP] = temp[55];
        data_rev_stream[7][reversed[56]% (int)TIME_STEP] = temp[56];
        data_rev_stream[39][reversed[57]% (int)TIME_STEP] = temp[57];
        data_rev_stream[23][reversed[58]% (int)TIME_STEP] = temp[58];
        data_rev_stream[55][reversed[59]% (int)TIME_STEP] = temp[59];
        data_rev_stream[15][reversed[60]% (int)TIME_STEP] = temp[60];
        data_rev_stream[47][reversed[61]% (int)TIME_STEP] = temp[61];
        data_rev_stream[31][reversed[62]% (int)TIME_STEP] = temp[62];
        data_rev_stream[63][reversed[63]% (int)TIME_STEP] = temp[63];
    }
