...
void reverse_read_stream_input (
    ...
    READ_STREAM_INPUT: for (int i = 0; i < TIME_STEP; i++){
        ...
        data_rev_stream[16][(int)reversed[1]% (int)TIME_STEP] = temp[1];
        data_rev_stream[8][(int)reversed[2]% (int)TIME_STEP] = temp[2];
        data_rev_stream[24][(int)reversed[3]% (int)TIME_STEP] = temp[3];
        data_rev_stream[4][reversed[4]% (int)TIME_STEP] = temp[4];
        data_rev_stream[20][reversed[5]% (int)TIME_STEP] = temp[5];
        data_rev_stream[12][reversed[6]% (int)TIME_STEP] = temp[6];
        data_rev_stream[28][reversed[7]% (int)TIME_STEP] = temp[7];
        data_rev_stream[2][reversed[8]% (int)TIME_STEP] = temp[8];
        data_rev_stream[18][reversed[9]% (int)TIME_STEP] = temp[9];
        data_rev_stream[10][reversed[10]% (int)TIME_STEP] = temp[10];
        data_rev_stream[26][reversed[11]% (int)TIME_STEP] = temp[11];
        data_rev_stream[6][reversed[12]% (int)TIME_STEP] = temp[12];
        data_rev_stream[22][reversed[13]% (int)TIME_STEP] = temp[13];
        data_rev_stream[14][reversed[14]% (int)TIME_STEP] = temp[14];
        data_rev_stream[30][reversed[15]% (int)TIME_STEP] = temp[15];
        data_rev_stream[1][reversed[16]% (int)TIME_STEP] = temp[16];
        data_rev_stream[17][reversed[17]% (int)TIME_STEP] = temp[17];
        data_rev_stream[9][reversed[18]% (int)TIME_STEP] = temp[18];
        data_rev_stream[25][reversed[19]% (int)TIME_STEP] = temp[19];
        data_rev_stream[5][reversed[20]% (int)TIME_STEP] = temp[20];
        data_rev_stream[21][reversed[21]% (int)TIME_STEP] = temp[21];
        data_rev_stream[13][reversed[22]% (int)TIME_STEP] = temp[22];
        data_rev_stream[29][reversed[23]% (int)TIME_STEP] = temp[23];
        data_rev_stream[3][reversed[24]% (int)TIME_STEP] = temp[24];
        data_rev_stream[19][reversed[25]% (int)TIME_STEP] = temp[25];
        data_rev_stream[11][reversed[26]% (int)TIME_STEP] = temp[26];
        data_rev_stream[27][reversed[27]% (int)TIME_STEP] = temp[27];
        data_rev_stream[7][reversed[28]% (int)TIME_STEP] = temp[28];
        data_rev_stream[23][reversed[29]% (int)TIME_STEP] = temp[29];
        data_rev_stream[15][reversed[30]% (int)TIME_STEP] = temp[30];
        data_rev_stream[31][reversed[31]% (int)TIME_STEP] = temp[31];
    }
...
void reverse_from_block_to_cyclic (
    ...
    FROM_BLOCK_TO_CYCLIC: for (int i = 0; i < TIME_STEP; i= i + 1){ 
        ...
        if (i%PAR ==0 ){
            ...
            cyclic_offset[16] = ((i+16)% (int)TIME_STEP+TIME_STEP*16)/PAR;
            cyclic_offset[17] = ((i+17)% (int)TIME_STEP+TIME_STEP*17)/PAR;
            cyclic_offset[18] = ((i+18)% (int)TIME_STEP+TIME_STEP*18)/PAR;
            cyclic_offset[19] = ((i+19)% (int)TIME_STEP+TIME_STEP*19)/PAR;
            cyclic_offset[20] = ((i+20)% (int)TIME_STEP+TIME_STEP*20)/PAR;
            cyclic_offset[21] = ((i+21)% (int)TIME_STEP+TIME_STEP*21)/PAR;
            cyclic_offset[22] = ((i+22)% (int)TIME_STEP+TIME_STEP*22)/PAR;
            cyclic_offset[23] = ((i+23)% (int)TIME_STEP+TIME_STEP*23)/PAR;
            cyclic_offset[24] = ((i+24)% (int)TIME_STEP+TIME_STEP*24)/PAR;
            cyclic_offset[25] = ((i+25)% (int)TIME_STEP+TIME_STEP*25)/PAR;
            cyclic_offset[26] = ((i+26)% (int)TIME_STEP+TIME_STEP*26)/PAR;
            cyclic_offset[27] = ((i+27)% (int)TIME_STEP+TIME_STEP*27)/PAR;
            cyclic_offset[28] = ((i+28)% (int)TIME_STEP+TIME_STEP*28)/PAR;
            cyclic_offset[29] = ((i+29)% (int)TIME_STEP+TIME_STEP*29)/PAR;
            cyclic_offset[30] = ((i+30)% (int)TIME_STEP+TIME_STEP*30)/PAR;
            cyclic_offset[31] = ((i+31)% (int)TIME_STEP+TIME_STEP*31)/PAR;
            ...
            cyclic_offset[0] = ((i+31)% (int)TIME_STEP+TIME_STEP*31)/PAR;
            ...
            cyclic_offset[16] = ((i+15)% (int)TIME_STEP+TIME_STEP*15)/PAR;
            cyclic_offset[17] = ((i+16)% (int)TIME_STEP+TIME_STEP*16)/PAR;
            cyclic_offset[18] = ((i+17)% (int)TIME_STEP+TIME_STEP*17)/PAR;
            cyclic_offset[19] = ((i+18)% (int)TIME_STEP+TIME_STEP*18)/PAR;
            cyclic_offset[20] = ((i+19)% (int)TIME_STEP+TIME_STEP*19)/PAR;
            cyclic_offset[21] = ((i+20)% (int)TIME_STEP+TIME_STEP*20)/PAR;
            cyclic_offset[22] = ((i+21)% (int)TIME_STEP+TIME_STEP*21)/PAR;
            cyclic_offset[23] = ((i+22)% (int)TIME_STEP+TIME_STEP*22)/PAR;
            cyclic_offset[24] = ((i+23)% (int)TIME_STEP+TIME_STEP*23)/PAR;
            cyclic_offset[25] = ((i+24)% (int)TIME_STEP+TIME_STEP*24)/PAR;
            cyclic_offset[26] = ((i+25)% (int)TIME_STEP+TIME_STEP*25)/PAR;
            cyclic_offset[27] = ((i+26)% (int)TIME_STEP+TIME_STEP*26)/PAR;
            cyclic_offset[28] = ((i+27)% (int)TIME_STEP+TIME_STEP*27)/PAR;
            cyclic_offset[29] = ((i+28)% (int)TIME_STEP+TIME_STEP*28)/PAR;
            cyclic_offset[30] = ((i+29)% (int)TIME_STEP+TIME_STEP*29)/PAR;
            cyclic_offset[31] = ((i+30)% (int)TIME_STEP+TIME_STEP*30)/PAR;
            ...
            cyclic_offset[0] = ((i+14)% (int)TIME_STEP+TIME_STEP*30)/PAR;
            cyclic_offset[1] = ((i+15)% (int)TIME_STEP+TIME_STEP*31)/PAR;
            ...
            cyclic_offset[16] = ((i+14)% (int)TIME_STEP+TIME_STEP*14)/PAR;
            cyclic_offset[17] = ((i+15)% (int)TIME_STEP+TIME_STEP*15)/PAR;
            cyclic_offset[18] = ((i+16)% (int)TIME_STEP+TIME_STEP*16)/PAR;
            cyclic_offset[19] = ((i+17)% (int)TIME_STEP+TIME_STEP*17)/PAR;
            cyclic_offset[20] = ((i+18)% (int)TIME_STEP+TIME_STEP*18)/PAR;
            cyclic_offset[21] = ((i+19)% (int)TIME_STEP+TIME_STEP*19)/PAR;
            cyclic_offset[22] = ((i+20)% (int)TIME_STEP+TIME_STEP*20)/PAR;
            cyclic_offset[23] = ((i+21)% (int)TIME_STEP+TIME_STEP*21)/PAR;
            cyclic_offset[24] = ((i+22)% (int)TIME_STEP+TIME_STEP*22)/PAR;
            cyclic_offset[25] = ((i+23)% (int)TIME_STEP+TIME_STEP*23)/PAR;
            cyclic_offset[26] = ((i+24)% (int)TIME_STEP+TIME_STEP*24)/PAR;
            cyclic_offset[27] = ((i+25)% (int)TIME_STEP+TIME_STEP*25)/PAR;
            cyclic_offset[28] = ((i+26)% (int)TIME_STEP+TIME_STEP*26)/PAR;
            cyclic_offset[29] = ((i+27)% (int)TIME_STEP+TIME_STEP*27)/PAR;
            cyclic_offset[30] = ((i+28)% (int)TIME_STEP+TIME_STEP*28)/PAR;
            cyclic_offset[31] = ((i+29)% (int)TIME_STEP+TIME_STEP*29)/PAR;
            ...
            cyclic_offset[0] = ((i+29)% (int)TIME_STEP+TIME_STEP*29)/PAR;
            cyclic_offset[1] = ((i+30)% (int)TIME_STEP+TIME_STEP*30)/PAR;
            cyclic_offset[2] = ((i+31)% (int)TIME_STEP+TIME_STEP*31)/PAR;
            ...
            cyclic_offset[16] = ((i+13)% (int)TIME_STEP+TIME_STEP*13)/PAR;
            cyclic_offset[17] = ((i+14)% (int)TIME_STEP+TIME_STEP*14)/PAR;
            cyclic_offset[18] = ((i+15)% (int)TIME_STEP+TIME_STEP*15)/PAR;
            cyclic_offset[19] = ((i+16)% (int)TIME_STEP+TIME_STEP*16)/PAR;
            cyclic_offset[20] = ((i+17)% (int)TIME_STEP+TIME_STEP*17)/PAR;
            cyclic_offset[21] = ((i+18)% (int)TIME_STEP+TIME_STEP*18)/PAR;
            cyclic_offset[22] = ((i+19)% (int)TIME_STEP+TIME_STEP*19)/PAR;
            cyclic_offset[23] = ((i+20)% (int)TIME_STEP+TIME_STEP*20)/PAR;
            cyclic_offset[24] = ((i+21)% (int)TIME_STEP+TIME_STEP*21)/PAR;
            cyclic_offset[25] = ((i+22)% (int)TIME_STEP+TIME_STEP*22)/PAR;
            cyclic_offset[26] = ((i+23)% (int)TIME_STEP+TIME_STEP*23)/PAR;
            cyclic_offset[27] = ((i+24)% (int)TIME_STEP+TIME_STEP*24)/PAR;
            cyclic_offset[28] = ((i+25)% (int)TIME_STEP+TIME_STEP*25)/PAR;
            cyclic_offset[29] = ((i+26)% (int)TIME_STEP+TIME_STEP*26)/PAR;
            cyclic_offset[30] = ((i+27)% (int)TIME_STEP+TIME_STEP*27)/PAR;
            cyclic_offset[31] = ((i+28)% (int)TIME_STEP+TIME_STEP*28)/PAR;
            ...
            cyclic_offset[0] = ((i+28)% (int)TIME_STEP+TIME_STEP*28)/PAR;
            cyclic_offset[1] = ((i+29)% (int)TIME_STEP+TIME_STEP*29)/PAR;
            cyclic_offset[2] = ((i+30)% (int)TIME_STEP+TIME_STEP*30)/PAR;
            cyclic_offset[3] = ((i+31)% (int)TIME_STEP+TIME_STEP*31)/PAR;
            ...
            cyclic_offset[16] = ((i+12)% (int)TIME_STEP+TIME_STEP*12)/PAR;
            cyclic_offset[17] = ((i+13)% (int)TIME_STEP+TIME_STEP*13)/PAR;
            cyclic_offset[18] = ((i+14)% (int)TIME_STEP+TIME_STEP*14)/PAR;
            cyclic_offset[19] = ((i+15)% (int)TIME_STEP+TIME_STEP*15)/PAR;
            cyclic_offset[20] = ((i+16)% (int)TIME_STEP+TIME_STEP*16)/PAR;
            cyclic_offset[21] = ((i+17)% (int)TIME_STEP+TIME_STEP*17)/PAR;
            cyclic_offset[22] = ((i+18)% (int)TIME_STEP+TIME_STEP*18)/PAR;
            cyclic_offset[23] = ((i+19)% (int)TIME_STEP+TIME_STEP*19)/PAR;
            cyclic_offset[24] = ((i+20)% (int)TIME_STEP+TIME_STEP*20)/PAR;
            cyclic_offset[25] = ((i+21)% (int)TIME_STEP+TIME_STEP*21)/PAR;
            cyclic_offset[26] = ((i+22)% (int)TIME_STEP+TIME_STEP*22)/PAR;
            cyclic_offset[27] = ((i+23)% (int)TIME_STEP+TIME_STEP*23)/PAR;
            cyclic_offset[28] = ((i+24)% (int)TIME_STEP+TIME_STEP*24)/PAR;
            cyclic_offset[29] = ((i+25)% (int)TIME_STEP+TIME_STEP*25)/PAR;
            cyclic_offset[30] = ((i+26)% (int)TIME_STEP+TIME_STEP*26)/PAR;
            cyclic_offset[31] = ((i+27)% (int)TIME_STEP+TIME_STEP*27)/PAR;
            ...
            cyclic_offset[0] = ((i+27)% (int)TIME_STEP+TIME_STEP*27)/PAR;
            cyclic_offset[1] = ((i+28)% (int)TIME_STEP+TIME_STEP*28)/PAR;
            cyclic_offset[2] = ((i+29)% (int)TIME_STEP+TIME_STEP*29)/PAR;
            cyclic_offset[3] = ((i+30)% (int)TIME_STEP+TIME_STEP*30)/PAR;
            cyclic_offset[4] = ((i+31)% (int)TIME_STEP+TIME_STEP*31)/PAR;
            ...
            cyclic_offset[16] = ((i+11)% (int)TIME_STEP+TIME_STEP*11)/PAR;
            cyclic_offset[17] = ((i+12)% (int)TIME_STEP+TIME_STEP*12)/PAR;
            cyclic_offset[18] = ((i+13)% (int)TIME_STEP+TIME_STEP*13)/PAR;
            cyclic_offset[19] = ((i+14)% (int)TIME_STEP+TIME_STEP*14)/PAR;
            cyclic_offset[20] = ((i+15)% (int)TIME_STEP+TIME_STEP*15)/PAR;
            cyclic_offset[21] = ((i+16)% (int)TIME_STEP+TIME_STEP*16)/PAR;
            cyclic_offset[22] = ((i+17)% (int)TIME_STEP+TIME_STEP*17)/PAR;
            cyclic_offset[23] = ((i+18)% (int)TIME_STEP+TIME_STEP*18)/PAR;
            cyclic_offset[24] = ((i+19)% (int)TIME_STEP+TIME_STEP*19)/PAR;
            cyclic_offset[25] = ((i+20)% (int)TIME_STEP+TIME_STEP*20)/PAR;
            cyclic_offset[26] = ((i+21)% (int)TIME_STEP+TIME_STEP*21)/PAR;
            cyclic_offset[27] = ((i+22)% (int)TIME_STEP+TIME_STEP*22)/PAR;
            cyclic_offset[28] = ((i+23)% (int)TIME_STEP+TIME_STEP*23)/PAR;
            cyclic_offset[29] = ((i+24)% (int)TIME_STEP+TIME_STEP*24)/PAR;
            cyclic_offset[30] = ((i+25)% (int)TIME_STEP+TIME_STEP*25)/PAR;
            cyclic_offset[31] = ((i+26)% (int)TIME_STEP+TIME_STEP*26)/PAR;
            ...
            cyclic_offset[0] = ((i+26)% (int)TIME_STEP+TIME_STEP*26)/PAR;
            cyclic_offset[1] = ((i+27)% (int)TIME_STEP+TIME_STEP*27)/PAR;
            cyclic_offset[2] = ((i+28)% (int)TIME_STEP+TIME_STEP*28)/PAR;
            cyclic_offset[3] = ((i+29)% (int)TIME_STEP+TIME_STEP*29)/PAR;
            cyclic_offset[4] = ((i+30)% (int)TIME_STEP+TIME_STEP*30)/PAR;
            cyclic_offset[5] = ((i+31)% (int)TIME_STEP+TIME_STEP*31)/PAR;
            ...
            cyclic_offset[16] = ((i+10)% (int)TIME_STEP+TIME_STEP*10)/PAR;
            cyclic_offset[17] = ((i+11)% (int)TIME_STEP+TIME_STEP*11)/PAR;
            cyclic_offset[18] = ((i+12)% (int)TIME_STEP+TIME_STEP*12)/PAR;
            cyclic_offset[19] = ((i+13)% (int)TIME_STEP+TIME_STEP*13)/PAR;
            cyclic_offset[20] = ((i+14)% (int)TIME_STEP+TIME_STEP*14)/PAR;
            cyclic_offset[21] = ((i+15)% (int)TIME_STEP+TIME_STEP*15)/PAR;
            cyclic_offset[22] = ((i+16)% (int)TIME_STEP+TIME_STEP*16)/PAR;
            cyclic_offset[23] = ((i+17)% (int)TIME_STEP+TIME_STEP*17)/PAR;
            cyclic_offset[24] = ((i+18)% (int)TIME_STEP+TIME_STEP*18)/PAR;
            cyclic_offset[25] = ((i+19)% (int)TIME_STEP+TIME_STEP*19)/PAR;
            cyclic_offset[26] = ((i+20)% (int)TIME_STEP+TIME_STEP*20)/PAR;
            cyclic_offset[27] = ((i+21)% (int)TIME_STEP+TIME_STEP*21)/PAR;
            cyclic_offset[28] = ((i+22)% (int)TIME_STEP+TIME_STEP*22)/PAR;
            cyclic_offset[29] = ((i+23)% (int)TIME_STEP+TIME_STEP*23)/PAR;
            cyclic_offset[30] = ((i+24)% (int)TIME_STEP+TIME_STEP*24)/PAR;
            cyclic_offset[31] = ((i+25)% (int)TIME_STEP+TIME_STEP*25)/PAR;
            ...
            cyclic_offset[0] = ((i+25)% (int)TIME_STEP+TIME_STEP*25)/PAR;
            cyclic_offset[1] = ((i+26)% (int)TIME_STEP+TIME_STEP*26)/PAR;
            cyclic_offset[2] = ((i+27)% (int)TIME_STEP+TIME_STEP*27)/PAR;
            cyclic_offset[3] = ((i+28)% (int)TIME_STEP+TIME_STEP*28)/PAR;
            cyclic_offset[4] = ((i+29)% (int)TIME_STEP+TIME_STEP*29)/PAR;
            cyclic_offset[5] = ((i+30)% (int)TIME_STEP+TIME_STEP*30)/PAR;
            cyclic_offset[6] = ((i+31)% (int)TIME_STEP+TIME_STEP*31)/PAR;
            ...
            cyclic_offset[16] = ((i+9)% (int)TIME_STEP+TIME_STEP*9)/PAR;
            cyclic_offset[17] = ((i+10)% (int)TIME_STEP+TIME_STEP*10)/PAR;
            cyclic_offset[18] = ((i+11)% (int)TIME_STEP+TIME_STEP*11)/PAR;
            cyclic_offset[19] = ((i+12)% (int)TIME_STEP+TIME_STEP*12)/PAR;
            cyclic_offset[20] = ((i+13)% (int)TIME_STEP+TIME_STEP*13)/PAR;
            cyclic_offset[21] = ((i+14)% (int)TIME_STEP+TIME_STEP*14)/PAR;
            cyclic_offset[22] = ((i+15)% (int)TIME_STEP+TIME_STEP*15)/PAR;
            cyclic_offset[23] = ((i+16)% (int)TIME_STEP+TIME_STEP*16)/PAR;
            cyclic_offset[24] = ((i+17)% (int)TIME_STEP+TIME_STEP*17)/PAR;
            cyclic_offset[25] = ((i+18)% (int)TIME_STEP+TIME_STEP*18)/PAR;
            cyclic_offset[26] = ((i+19)% (int)TIME_STEP+TIME_STEP*19)/PAR;
            cyclic_offset[27] = ((i+20)% (int)TIME_STEP+TIME_STEP*20)/PAR;
            cyclic_offset[28] = ((i+21)% (int)TIME_STEP+TIME_STEP*21)/PAR;
            cyclic_offset[29] = ((i+22)% (int)TIME_STEP+TIME_STEP*22)/PAR;
            cyclic_offset[30] = ((i+23)% (int)TIME_STEP+TIME_STEP*23)/PAR;
            cyclic_offset[31] = ((i+24)% (int)TIME_STEP+TIME_STEP*24)/PAR;
            ...
            cyclic_offset[0] = ((i+24)% (int)TIME_STEP+TIME_STEP*24)/PAR;
            cyclic_offset[1] = ((i+25)% (int)TIME_STEP+TIME_STEP*25)/PAR;
            cyclic_offset[2] = ((i+26)% (int)TIME_STEP+TIME_STEP*26)/PAR;
            cyclic_offset[3] = ((i+27)% (int)TIME_STEP+TIME_STEP*27)/PAR;
            cyclic_offset[4] = ((i+28)% (int)TIME_STEP+TIME_STEP*28)/PAR;
            cyclic_offset[5] = ((i+29)% (int)TIME_STEP+TIME_STEP*29)/PAR;
            cyclic_offset[6] = ((i+30)% (int)TIME_STEP+TIME_STEP*30)/PAR;
            cyclic_offset[7] = ((i+31)% (int)TIME_STEP+TIME_STEP*31)/PAR;
            ...
            cyclic_offset[16] = ((i+8)% (int)TIME_STEP+TIME_STEP*8)/PAR;
            cyclic_offset[17] = ((i+9)% (int)TIME_STEP+TIME_STEP*9)/PAR;
            cyclic_offset[18] = ((i+10)% (int)TIME_STEP+TIME_STEP*10)/PAR;
            cyclic_offset[19] = ((i+11)% (int)TIME_STEP+TIME_STEP*11)/PAR;
            cyclic_offset[20] = ((i+12)% (int)TIME_STEP+TIME_STEP*12)/PAR;
            cyclic_offset[21] = ((i+13)% (int)TIME_STEP+TIME_STEP*13)/PAR;
            cyclic_offset[22] = ((i+14)% (int)TIME_STEP+TIME_STEP*14)/PAR;
            cyclic_offset[23] = ((i+15)% (int)TIME_STEP+TIME_STEP*15)/PAR;
            cyclic_offset[24] = ((i+16)% (int)TIME_STEP+TIME_STEP*16)/PAR;
            cyclic_offset[25] = ((i+17)% (int)TIME_STEP+TIME_STEP*17)/PAR;
            cyclic_offset[26] = ((i+18)% (int)TIME_STEP+TIME_STEP*18)/PAR;
            cyclic_offset[27] = ((i+19)% (int)TIME_STEP+TIME_STEP*19)/PAR;
            cyclic_offset[28] = ((i+20)% (int)TIME_STEP+TIME_STEP*20)/PAR;
            cyclic_offset[29] = ((i+21)% (int)TIME_STEP+TIME_STEP*21)/PAR;
            cyclic_offset[30] = ((i+22)% (int)TIME_STEP+TIME_STEP*22)/PAR;
            cyclic_offset[31] = ((i+23)% (int)TIME_STEP+TIME_STEP*23)/PAR;
            ...
            cyclic_offset[0] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[1] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[2] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[3] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[4] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[5] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[6] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[7] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[8] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            ...
            cyclic_offset[16] = ((i + 7) % (int)TIME_STEP + TIME_STEP * 7) / PAR;
            cyclic_offset[17] = ((i + 8) % (int)TIME_STEP + TIME_STEP * 8) / PAR;
            cyclic_offset[18] = ((i + 9) % (int)TIME_STEP + TIME_STEP * 9) / PAR;
            cyclic_offset[19] = ((i + 10) % (int)TIME_STEP + TIME_STEP * 10) / PAR;
            cyclic_offset[20] = ((i + 11) % (int)TIME_STEP + TIME_STEP * 11) / PAR;
            cyclic_offset[21] = ((i + 12) % (int)TIME_STEP + TIME_STEP * 12) / PAR;
            cyclic_offset[22] = ((i + 13) % (int)TIME_STEP + TIME_STEP * 13) / PAR;
            cyclic_offset[23] = ((i + 14) % (int)TIME_STEP + TIME_STEP * 14) / PAR;
            cyclic_offset[24] = ((i + 15) % (int)TIME_STEP + TIME_STEP * 15) / PAR;
            cyclic_offset[25] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[26] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[27] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[28] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[29] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[30] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[31] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            ...
            cyclic_offset[0] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[1] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[2] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[3] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[4] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[5] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[6] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[7] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[8] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[9] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            ...
            cyclic_offset[16] = ((i + 6) % (int)TIME_STEP + TIME_STEP * 6) / PAR;
            cyclic_offset[17] = ((i + 7) % (int)TIME_STEP + TIME_STEP * 7) / PAR;
            cyclic_offset[18] = ((i + 8) % (int)TIME_STEP + TIME_STEP * 8) / PAR;
            cyclic_offset[19] = ((i + 9) % (int)TIME_STEP + TIME_STEP * 9) / PAR;
            cyclic_offset[20] = ((i + 10) % (int)TIME_STEP + TIME_STEP * 10) / PAR;
            cyclic_offset[21] = ((i + 11) % (int)TIME_STEP + TIME_STEP * 11) / PAR;
            cyclic_offset[22] = ((i + 12) % (int)TIME_STEP + TIME_STEP * 12) / PAR;
            cyclic_offset[23] = ((i + 13) % (int)TIME_STEP + TIME_STEP * 13) / PAR;
            cyclic_offset[24] = ((i + 14) % (int)TIME_STEP + TIME_STEP * 14) / PAR;
            cyclic_offset[25] = ((i + 15) % (int)TIME_STEP + TIME_STEP * 15) / PAR;
            cyclic_offset[26] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[27] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[28] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[29] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[30] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[31] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            ...
            cyclic_offset[0] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[1] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[2] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[3] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[4] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[5] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[6] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[7] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[8] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[9] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[10] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            ...
            cyclic_offset[16] = ((i + 5) % (int)TIME_STEP + TIME_STEP * 5) / PAR;
            cyclic_offset[17] = ((i + 6) % (int)TIME_STEP + TIME_STEP * 6) / PAR;
            cyclic_offset[18] = ((i + 7) % (int)TIME_STEP + TIME_STEP * 7) / PAR;
            cyclic_offset[19] = ((i + 8) % (int)TIME_STEP + TIME_STEP * 8) / PAR;
            cyclic_offset[20] = ((i + 9) % (int)TIME_STEP + TIME_STEP * 9) / PAR;
            cyclic_offset[21] = ((i + 10) % (int)TIME_STEP + TIME_STEP * 10) / PAR;
            cyclic_offset[22] = ((i + 11) % (int)TIME_STEP + TIME_STEP * 11) / PAR;
            cyclic_offset[23] = ((i + 12) % (int)TIME_STEP + TIME_STEP * 12) / PAR;
            cyclic_offset[24] = ((i + 13) % (int)TIME_STEP + TIME_STEP * 13) / PAR;
            cyclic_offset[25] = ((i + 14) % (int)TIME_STEP + TIME_STEP * 14) / PAR;
            cyclic_offset[26] = ((i + 15) % (int)TIME_STEP + TIME_STEP * 15) / PAR;
            cyclic_offset[27] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[28] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[29] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[30] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[31] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            ...
            cyclic_offset[0] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[1] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[2] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[3] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[4] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[5] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[6] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[7] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[8] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[9] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[10] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[11] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            ...
            cyclic_offset[16] = ((i + 4) % (int)TIME_STEP + TIME_STEP * 4) / PAR;
            cyclic_offset[17] = ((i + 5) % (int)TIME_STEP + TIME_STEP * 5) / PAR;
            cyclic_offset[18] = ((i + 6) % (int)TIME_STEP + TIME_STEP * 6) / PAR;
            cyclic_offset[19] = ((i + 7) % (int)TIME_STEP + TIME_STEP * 7) / PAR;
            cyclic_offset[20] = ((i + 8) % (int)TIME_STEP + TIME_STEP * 8) / PAR;
            cyclic_offset[21] = ((i + 9) % (int)TIME_STEP + TIME_STEP * 9) / PAR;
            cyclic_offset[22] = ((i + 10) % (int)TIME_STEP + TIME_STEP * 10) / PAR;
            cyclic_offset[23] = ((i + 11) % (int)TIME_STEP + TIME_STEP * 11) / PAR;
            cyclic_offset[24] = ((i + 12) % (int)TIME_STEP + TIME_STEP * 12) / PAR;
            cyclic_offset[25] = ((i + 13) % (int)TIME_STEP + TIME_STEP * 13) / PAR;
            cyclic_offset[26] = ((i + 14) % (int)TIME_STEP + TIME_STEP * 14) / PAR;
            cyclic_offset[27] = ((i + 15) % (int)TIME_STEP + TIME_STEP * 15) / PAR;
            cyclic_offset[28] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[29] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[30] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[31] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            ...
            cyclic_offset[0] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[1] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[2] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[3] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[4] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[5] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[6] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[7] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[8] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[9] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[10] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[11] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[12] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[13] = i / PAR;
            cyclic_offset[14] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[15] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            cyclic_offset[16] = ((i + 3) % (int)TIME_STEP + TIME_STEP * 3) / PAR;
            cyclic_offset[17] = ((i + 4) % (int)TIME_STEP + TIME_STEP * 4) / PAR;
            cyclic_offset[18] = ((i + 5) % (int)TIME_STEP + TIME_STEP * 5) / PAR;
            cyclic_offset[19] = ((i + 6) % (int)TIME_STEP + TIME_STEP * 6) / PAR;
            cyclic_offset[20] = ((i + 7) % (int)TIME_STEP + TIME_STEP * 7) / PAR;
            cyclic_offset[21] = ((i + 8) % (int)TIME_STEP + TIME_STEP * 8) / PAR;
            cyclic_offset[22] = ((i + 9) % (int)TIME_STEP + TIME_STEP * 9) / PAR;
            cyclic_offset[23] = ((i + 10) % (int)TIME_STEP + TIME_STEP * 10) / PAR;
            cyclic_offset[24] = ((i + 11) % (int)TIME_STEP + TIME_STEP * 11) / PAR;
            cyclic_offset[25] = ((i + 12) % (int)TIME_STEP + TIME_STEP * 12) / PAR;
            cyclic_offset[26] = ((i + 13) % (int)TIME_STEP + TIME_STEP * 13) / PAR;
            cyclic_offset[27] = ((i + 14) % (int)TIME_STEP + TIME_STEP * 14) / PAR;
            cyclic_offset[28] = ((i + 15) % (int)TIME_STEP + TIME_STEP * 15) / PAR;
            cyclic_offset[29] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[30] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[31] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            ...
            cyclic_offset[0] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[1] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[2] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[3] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[4] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[5] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[6] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[7] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[8] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[9] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[10] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[11] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[12] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[13] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[14] = i / PAR;
            cyclic_offset[15] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[16] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            cyclic_offset[17] = ((i + 3) % (int)TIME_STEP + TIME_STEP * 3) / PAR;
            cyclic_offset[18] = ((i + 4) % (int)TIME_STEP + TIME_STEP * 4) / PAR;
            cyclic_offset[19] = ((i + 5) % (int)TIME_STEP + TIME_STEP * 5) / PAR;
            cyclic_offset[20] = ((i + 6) % (int)TIME_STEP + TIME_STEP * 6) / PAR;
            cyclic_offset[21] = ((i + 7) % (int)TIME_STEP + TIME_STEP * 7) / PAR;
            cyclic_offset[22] = ((i + 8) % (int)TIME_STEP + TIME_STEP * 8) / PAR;
            cyclic_offset[23] = ((i + 9) % (int)TIME_STEP + TIME_STEP * 9) / PAR;
            cyclic_offset[24] = ((i + 10) % (int)TIME_STEP + TIME_STEP * 10) / PAR;
            cyclic_offset[25] = ((i + 11) % (int)TIME_STEP + TIME_STEP * 11) / PAR;
            cyclic_offset[26] = ((i + 12) % (int)TIME_STEP + TIME_STEP * 12) / PAR;
            cyclic_offset[27] = ((i + 13) % (int)TIME_STEP + TIME_STEP * 13) / PAR;
            cyclic_offset[28] = ((i + 14) % (int)TIME_STEP + TIME_STEP * 14) / PAR;
            cyclic_offset[29] = ((i + 15) % (int)TIME_STEP + TIME_STEP * 15) / PAR;
            cyclic_offset[30] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[31] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            ...
            cyclic_offset[0] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[1] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[2] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[3] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[4] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[5] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[6] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[7] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[8] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[9] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[10] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[11] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[12] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[13] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[14] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[15] = i / PAR;
            cyclic_offset[16] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[17] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            cyclic_offset[18] = ((i + 3) % (int)TIME_STEP + TIME_STEP * 3) / PAR;
            cyclic_offset[19] = ((i + 4) % (int)TIME_STEP + TIME_STEP * 4) / PAR;
            cyclic_offset[20] = ((i + 5) % (int)TIME_STEP + TIME_STEP * 5) / PAR;
            cyclic_offset[21] = ((i + 6) % (int)TIME_STEP + TIME_STEP * 6) / PAR;
            cyclic_offset[22] = ((i + 7) % (int)TIME_STEP + TIME_STEP * 7) / PAR;
            cyclic_offset[23] = ((i + 8) % (int)TIME_STEP + TIME_STEP * 8) / PAR;
            cyclic_offset[24] = ((i + 9) % (int)TIME_STEP + TIME_STEP * 9) / PAR;
            cyclic_offset[25] = ((i + 10) % (int)TIME_STEP + TIME_STEP * 10) / PAR;
            cyclic_offset[26] = ((i + 11) % (int)TIME_STEP + TIME_STEP * 11) / PAR;
            cyclic_offset[27] = ((i + 12) % (int)TIME_STEP + TIME_STEP * 12) / PAR;
            cyclic_offset[28] = ((i + 13) % (int)TIME_STEP + TIME_STEP * 13) / PAR;
            cyclic_offset[29] = ((i + 14) % (int)TIME_STEP + TIME_STEP * 14) / PAR;
            cyclic_offset[30] = ((i + 15) % (int)TIME_STEP + TIME_STEP * 15) / PAR;
            cyclic_offset[31] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            ...
            cyclic_offset[0] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[1] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[2] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[3] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[4] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[5] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[6] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[7] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[8] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[9] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[10] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[11] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[12] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[13] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[14] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[15] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[16] = i / PAR;
            cyclic_offset[17] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[18] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            cyclic_offset[19] = ((i + 3) % (int)TIME_STEP + TIME_STEP * 3) / PAR;
            cyclic_offset[20] = ((i + 4) % (int)TIME_STEP + TIME_STEP * 4) / PAR;
            cyclic_offset[21] = ((i + 5) % (int)TIME_STEP + TIME_STEP * 5) / PAR;
            cyclic_offset[22] = ((i + 6) % (int)TIME_STEP + TIME_STEP * 6) / PAR;
            cyclic_offset[23] = ((i + 7) % (int)TIME_STEP + TIME_STEP * 7) / PAR;
            cyclic_offset[24] = ((i + 8) % (int)TIME_STEP + TIME_STEP * 8) / PAR;
            cyclic_offset[25] = ((i + 9) % (int)TIME_STEP + TIME_STEP * 9) / PAR;
            cyclic_offset[26] = ((i + 10) % (int)TIME_STEP + TIME_STEP * 10) / PAR;
            cyclic_offset[27] = ((i + 11) % (int)TIME_STEP + TIME_STEP * 11) / PAR;
            cyclic_offset[28] = ((i + 12) % (int)TIME_STEP + TIME_STEP * 12) / PAR;
            cyclic_offset[29] = ((i + 13) % (int)TIME_STEP + TIME_STEP * 13) / PAR;
            cyclic_offset[30] = ((i + 14) % (int)TIME_STEP + TIME_STEP * 14) / PAR;
            cyclic_offset[31] = ((i + 15) % (int)TIME_STEP + TIME_STEP * 15) / PAR;
            ...
            cyclic_offset[1] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[2] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[3] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[4] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[5] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[6] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[7] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[8] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[9] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[10] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[11] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[12] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[13] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[14] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[15] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[16] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[17] = i / PAR;
            cyclic_offset[18] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[19] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            cyclic_offset[20] = ((i + 3) % (int)TIME_STEP + TIME_STEP * 3) / PAR;
            cyclic_offset[21] = ((i + 4) % (int)TIME_STEP + TIME_STEP * 4) / PAR;
            cyclic_offset[22] = ((i + 5) % (int)TIME_STEP + TIME_STEP * 5) / PAR;
            cyclic_offset[23] = ((i + 6) % (int)TIME_STEP + TIME_STEP * 6) / PAR;
            cyclic_offset[24] = ((i + 7) % (int)TIME_STEP + TIME_STEP * 7) / PAR;
            cyclic_offset[25] = ((i + 8) % (int)TIME_STEP + TIME_STEP * 8) / PAR;
            cyclic_offset[26] = ((i + 9) % (int)TIME_STEP + TIME_STEP * 9) / PAR;
            cyclic_offset[27] = ((i + 10) % (int)TIME_STEP + TIME_STEP * 10) / PAR;
            cyclic_offset[28] = ((i + 11) % (int)TIME_STEP + TIME_STEP * 11) / PAR;
            cyclic_offset[29] = ((i + 12) % (int)TIME_STEP + TIME_STEP * 12) / PAR;
            cyclic_offset[30] = ((i + 13) % (int)TIME_STEP + TIME_STEP * 13) / PAR;
            cyclic_offset[31] = ((i + 14) % (int)TIME_STEP + TIME_STEP * 14) / PAR;
            ...
            cyclic_offset[2] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[3] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[4] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[5] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[6] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[7] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[8] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[9] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[10] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[11] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[12] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[13] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[14] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[15] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[16] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[17] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[18] = i / PAR;
            cyclic_offset[19] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[20] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            cyclic_offset[21] = ((i + 3) % (int)TIME_STEP + TIME_STEP * 3) / PAR;
            cyclic_offset[22] = ((i + 4) % (int)TIME_STEP + TIME_STEP * 4) / PAR;
            cyclic_offset[23] = ((i + 5) % (int)TIME_STEP + TIME_STEP * 5) / PAR;
            cyclic_offset[24] = ((i + 6) % (int)TIME_STEP + TIME_STEP * 6) / PAR;
            cyclic_offset[25] = ((i + 7) % (int)TIME_STEP + TIME_STEP * 7) / PAR;
            cyclic_offset[26] = ((i + 8) % (int)TIME_STEP + TIME_STEP * 8) / PAR;
            cyclic_offset[27] = ((i + 9) % (int)TIME_STEP + TIME_STEP * 9) / PAR;
            cyclic_offset[28] = ((i + 10) % (int)TIME_STEP + TIME_STEP * 10) / PAR;
            cyclic_offset[29] = ((i + 11) % (int)TIME_STEP + TIME_STEP * 11) / PAR;
            cyclic_offset[30] = ((i + 12) % (int)TIME_STEP + TIME_STEP * 12) / PAR;
            cyclic_offset[31] = ((i + 13) % (int)TIME_STEP + TIME_STEP * 13) / PAR;
            ...
            cyclic_offset[3] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[4] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[5] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[6] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[7] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[8] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[9] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[10] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[11] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[12] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[13] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[14] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[15] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[16] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[17] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[18] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[19] = i / PAR;
            cyclic_offset[20] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[21] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            cyclic_offset[22] = ((i + 3) % (int)TIME_STEP + TIME_STEP * 3) / PAR;
            cyclic_offset[23] = ((i + 4) % (int)TIME_STEP + TIME_STEP * 4) / PAR;
            cyclic_offset[24] = ((i + 5) % (int)TIME_STEP + TIME_STEP * 5) / PAR;
            cyclic_offset[25] = ((i + 6) % (int)TIME_STEP + TIME_STEP * 6) / PAR;
            cyclic_offset[26] = ((i + 7) % (int)TIME_STEP + TIME_STEP * 7) / PAR;
            cyclic_offset[27] = ((i + 8) % (int)TIME_STEP + TIME_STEP * 8) / PAR;
            cyclic_offset[28] = ((i + 9) % (int)TIME_STEP + TIME_STEP * 9) / PAR;
            cyclic_offset[29] = ((i + 10) % (int)TIME_STEP + TIME_STEP * 10) / PAR;
            cyclic_offset[30] = ((i + 11) % (int)TIME_STEP + TIME_STEP * 11) / PAR;
            cyclic_offset[31] = ((i + 12) % (int)TIME_STEP + TIME_STEP * 12) / PAR;
            ...
            cyclic_offset[4] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[5] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[6] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[7] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[8] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[9] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[10] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[11] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[12] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[13] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[14] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[15] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[16] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[17] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[18] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[19] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[20] = i / PAR;
            cyclic_offset[21] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[22] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            cyclic_offset[23] = ((i + 3) % (int)TIME_STEP + TIME_STEP * 3) / PAR;
            cyclic_offset[24] = ((i + 4) % (int)TIME_STEP + TIME_STEP * 4) / PAR;
            cyclic_offset[25] = ((i + 5) % (int)TIME_STEP + TIME_STEP * 5) / PAR;
            cyclic_offset[26] = ((i + 6) % (int)TIME_STEP + TIME_STEP * 6) / PAR;
            cyclic_offset[27] = ((i + 7) % (int)TIME_STEP + TIME_STEP * 7) / PAR;
            cyclic_offset[28] = ((i + 8) % (int)TIME_STEP + TIME_STEP * 8) / PAR;
            cyclic_offset[29] = ((i + 9) % (int)TIME_STEP + TIME_STEP * 9) / PAR;
            cyclic_offset[30] = ((i + 10) % (int)TIME_STEP + TIME_STEP * 10) / PAR;
            cyclic_offset[31] = ((i + 11) % (int)TIME_STEP + TIME_STEP * 11) / PAR;
            ...
            cyclic_offset[5] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[6] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[7] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[8] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[9] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[10] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[11] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[12] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[13] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[14] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[15] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[16] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[17] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[18] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[19] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[20] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[21] = i / PAR;
            cyclic_offset[22] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[23] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            cyclic_offset[24] = ((i + 3) % (int)TIME_STEP + TIME_STEP * 3) / PAR;
            cyclic_offset[25] = ((i + 4) % (int)TIME_STEP + TIME_STEP * 4) / PAR;
            cyclic_offset[26] = ((i + 5) % (int)TIME_STEP + TIME_STEP * 5) / PAR;
            cyclic_offset[27] = ((i + 6) % (int)TIME_STEP + TIME_STEP * 6) / PAR;
            cyclic_offset[28] = ((i + 7) % (int)TIME_STEP + TIME_STEP * 7) / PAR;
            cyclic_offset[29] = ((i + 8) % (int)TIME_STEP + TIME_STEP * 8) / PAR;
            cyclic_offset[30] = ((i + 9) % (int)TIME_STEP + TIME_STEP * 9) / PAR;
            cyclic_offset[31] = ((i + 10) % (int)TIME_STEP + TIME_STEP * 10) / PAR;
            ...
            cyclic_offset[6] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[7] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[8] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[9] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[10] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[11] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[12] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[13] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[14] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[15] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[16] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[17] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[18] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[19] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[20] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[21] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[22] = i / PAR;
            cyclic_offset[23] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[24] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            cyclic_offset[25] = ((i + 3) % (int)TIME_STEP + TIME_STEP * 3) / PAR;
            cyclic_offset[26] = ((i + 4) % (int)TIME_STEP + TIME_STEP * 4) / PAR;
            cyclic_offset[27] = ((i + 5) % (int)TIME_STEP + TIME_STEP * 5) / PAR;
            cyclic_offset[28] = ((i + 6) % (int)TIME_STEP + TIME_STEP * 6) / PAR;
            cyclic_offset[29] = ((i + 7) % (int)TIME_STEP + TIME_STEP * 7) / PAR;
            cyclic_offset[30] = ((i + 8) % (int)TIME_STEP + TIME_STEP * 8) / PAR;
            cyclic_offset[31] = ((i + 9) % (int)TIME_STEP + TIME_STEP * 9) / PAR;
            ...
            cyclic_offset[7] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[8] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[9] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[10] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[11] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[12] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[13] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[14] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[15] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[16] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[17] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[18] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[19] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[20] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[21] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[22] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[23] = i / PAR;
            cyclic_offset[24] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[25] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            cyclic_offset[26] = ((i + 3) % (int)TIME_STEP + TIME_STEP * 3) / PAR;
            cyclic_offset[27] = ((i + 4) % (int)TIME_STEP + TIME_STEP * 4) / PAR;
            cyclic_offset[28] = ((i + 5) % (int)TIME_STEP + TIME_STEP * 5) / PAR;
            cyclic_offset[29] = ((i + 6) % (int)TIME_STEP + TIME_STEP * 6) / PAR;
            cyclic_offset[30] = ((i + 7) % (int)TIME_STEP + TIME_STEP * 7) / PAR;
            cyclic_offset[31] = ((i + 8) % (int)TIME_STEP + TIME_STEP * 8) / PAR;
            ...
            cyclic_offset[8] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[9] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[10] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[11] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[12] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[13] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[14] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[15] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[16] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[17] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[18] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[19] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[20] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[21] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[22] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[23] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[24] = i / PAR;
            cyclic_offset[25] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[26] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            cyclic_offset[27] = ((i + 3) % (int)TIME_STEP + TIME_STEP * 3) / PAR;
            cyclic_offset[28] = ((i + 4) % (int)TIME_STEP + TIME_STEP * 4) / PAR;
            cyclic_offset[29] = ((i + 5) % (int)TIME_STEP + TIME_STEP * 5) / PAR;
            cyclic_offset[30] = ((i + 6) % (int)TIME_STEP + TIME_STEP * 6) / PAR;
            cyclic_offset[31] = ((i + 7) % (int)TIME_STEP + TIME_STEP * 7) / PAR;
            ...
            cyclic_offset[9] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[10] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[11] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[12] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[13] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[14] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[15] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[16] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[17] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[18] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[19] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[20] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[21] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[22] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[23] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[24] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[25] = i / PAR;
            cyclic_offset[26] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[27] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            cyclic_offset[28] = ((i + 3) % (int)TIME_STEP + TIME_STEP * 3) / PAR;
            cyclic_offset[29] = ((i + 4) % (int)TIME_STEP + TIME_STEP * 4) / PAR;
            cyclic_offset[30] = ((i + 5) % (int)TIME_STEP + TIME_STEP * 5) / PAR;
            cyclic_offset[31] = ((i + 6) % (int)TIME_STEP + TIME_STEP * 6) / PAR;
            ...
            cyclic_offset[10] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[11] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[12] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[13] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[14] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[15] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[16] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[17] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[18] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[19] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[20] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[21] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[22] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[23] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[24] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[25] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[26] = i / PAR;
            cyclic_offset[27] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[28] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            cyclic_offset[29] = ((i + 3) % (int)TIME_STEP + TIME_STEP * 3) / PAR;
            cyclic_offset[30] = ((i + 4) % (int)TIME_STEP + TIME_STEP * 4) / PAR;
            cyclic_offset[31] = ((i + 5) % (int)TIME_STEP + TIME_STEP * 5) / PAR;
            ...
            cyclic_offset[11] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[12] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[13] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[14] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[15] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[16] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[17] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[18] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[19] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[20] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[21] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[22] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[23] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[24] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[25] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[26] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[27] = i / PAR;
            cyclic_offset[28] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[29] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            cyclic_offset[30] = ((i + 3) % (int)TIME_STEP + TIME_STEP * 3) / PAR;
            cyclic_offset[31] = ((i + 4) % (int)TIME_STEP + TIME_STEP * 4) / PAR;
            ...
            cyclic_offset[12] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[13] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[14] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[15] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[16] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[17] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[18] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[19] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[20] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[21] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[22] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[23] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[24] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[25] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[26] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[27] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[28] = i / PAR;
            cyclic_offset[29] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[30] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            cyclic_offset[31] = ((i + 3) % (int)TIME_STEP + TIME_STEP * 3) / PAR;
            ...
            cyclic_offset[13] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[14] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[15] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[16] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[17] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[18] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[19] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[20] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[21] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[22] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[23] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[24] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[25] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[26] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[27] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[28] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[29] = i / PAR;
            cyclic_offset[30] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            cyclic_offset[31] = ((i + 2) % (int)TIME_STEP + TIME_STEP * 2) / PAR;
            ...
            cyclic_offset[14] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[15] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[16] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[17] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[18] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[19] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[20] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[21] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[22] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[23] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[24] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[25] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[26] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[27] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[28] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[29] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
            cyclic_offset[30] = i / PAR;
            cyclic_offset[31] = ((i + 1) % (int)TIME_STEP + TIME_STEP) / PAR;
            ...
            cyclic_offset[0] = ((i + 1) % (int)TIME_STEP + TIME_STEP * 1) / PAR;
            ...
            cyclic_offset[15] = ((i + 16) % (int)TIME_STEP + TIME_STEP * 16) / PAR;
            cyclic_offset[16] = ((i + 17) % (int)TIME_STEP + TIME_STEP * 17) / PAR;
            cyclic_offset[17] = ((i + 18) % (int)TIME_STEP + TIME_STEP * 18) / PAR;
            cyclic_offset[18] = ((i + 19) % (int)TIME_STEP + TIME_STEP * 19) / PAR;
            cyclic_offset[19] = ((i + 20) % (int)TIME_STEP + TIME_STEP * 20) / PAR;
            cyclic_offset[20] = ((i + 21) % (int)TIME_STEP + TIME_STEP * 21) / PAR;
            cyclic_offset[21] = ((i + 22) % (int)TIME_STEP + TIME_STEP * 22) / PAR;
            cyclic_offset[22] = ((i + 23) % (int)TIME_STEP + TIME_STEP * 23) / PAR;
            cyclic_offset[23] = ((i + 24) % (int)TIME_STEP + TIME_STEP * 24) / PAR;
            cyclic_offset[24] = ((i + 25) % (int)TIME_STEP + TIME_STEP * 25) / PAR;
            cyclic_offset[25] = ((i + 26) % (int)TIME_STEP + TIME_STEP * 26) / PAR;
            cyclic_offset[26] = ((i + 27) % (int)TIME_STEP + TIME_STEP * 27) / PAR;
            cyclic_offset[27] = ((i + 28) % (int)TIME_STEP + TIME_STEP * 28) / PAR;
            cyclic_offset[28] = ((i + 29) % (int)TIME_STEP + TIME_STEP * 29) / PAR;
            cyclic_offset[29] = ((i + 30) % (int)TIME_STEP + TIME_STEP * 30) / PAR;
            cyclic_offset[30] = ((i + 31) % (int)TIME_STEP + TIME_STEP * 31) / PAR;
...
void reverse_input_stream_UF16 (
    ...
    //     for (int i = 0; i < UF*2; i++){
    //         int index = j*UF*2+i;
    //         if(data_in_cyclic[i][j] != data_rev_stream[index/TIME_STEP][index% (int)TIME_STEP]) {
