...
extern "C"{
#pragma HLS inputclk src_clk 10
void top(A_t16 *A, B_t16 *B, C_t16 *C){
    ...
    #pragma HLS INTERFACE s_axilite port=C bundle=control
    #pragma HLS INTERFACE s_axilite port=return bundle=control
    #pragma HLS allocation function instances=kernel_m2_0 limit=1
    ...
    #pragma HLS clkdomain clk1 10
    kernel_m2_0(C_temp3, C_temp3, C_temp6);
    #pragma HLS clkdomain clk2 40
    kernel_c0(C_temp4, C_temp5);
    #pragma HLS clkdomain clk1 10
    kernel_merge(C_temp5, C_temp6, C);
}
}
