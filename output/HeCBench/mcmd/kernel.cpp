...
{
    #pragma HLS INTERFACE m_axi port=atom_list offset=slave bundle=gmem0
    #pragma HLS INTERFACE s_axilite port=N
    #pragma HLS INTERFACE s_axilite port=cutoffD
    #pragma HLS INTERFACE m_axi port=basis offset=slave bundle=gmem1
    #pragma HLS INTERFACE m_axi port=reciprocal_basis offset=slave bundle=gmem2
    #pragma HLS INTERFACE s_axilite port=pformD
    #pragma HLS INTERFACE s_axilite port=ewald_alpha
    #pragma HLS INTERFACE s_axilite port=kmax
    #pragma HLS INTERFACE s_axilite port=kspace
    #pragma HLS INTERFACE s_axilite port=polar_damp
    ...
    for (int _bid_x = 0; _bid_x < GRID_DIM_X; _bid_x++) {
        ...
        #pragma HLS PIPELINE II=1
            ...
            int i = _tid_x + BLOCK_DIM_X * _bid_x;
            if(i < N) {
