...
#include <cstdint>
  ...
  #define HOST         #define DEVICE       #define HOST_DEVICE  #else
  #define HOST
  #define DEVICE
  #define HOST_DEVICE
#endif
...
// is used to enable the  keyword/modifier for the data
// passed to cuda.
template <typename T>
...
// The PtrTraits argument is only relevant to cuda to support `` pointers.
...
// Use RestrictPtrTraits as PtrTraits if you want the tensor's data pointer to be marked as .
