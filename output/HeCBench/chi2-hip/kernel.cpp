  ...
  float * results)
{
    ...
    #pragma HLS INTERFACE s_axilite port=cRows
    #pragma HLS INTERFACE s_axilite port=contRows
    #pragma HLS INTERFACE m_axi port=snpdata offset=slave bundle=gmem0
