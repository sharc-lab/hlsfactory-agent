...
void decode(const float *__restrict d_scores, 
    ...
    #pragma HLS INTERFACE m_axi port=d_scores offset=slave bundle=gmem0
    #pragma HLS INTERFACE m_axi port=d_encrypted offset=slave bundle=gmem1
    #pragma HLS INTERFACE m_axi port=globalState offset=slave bundle=gmem2
    #pragma HLS INTERFACE m_axi port=d_decrypted offset=slave bundle=gmem3
    #pragma HLS INTERFACE s_axilite port=return
    #pragma HLS ARRAY_PARTITION variable=shared_scores complete dim=1
