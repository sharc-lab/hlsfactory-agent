...
template <class T>
void Add1(T *data, int nIters, T v) {
...
template <class T>
void Add2(T *data, int nIters, T v) {
  int gid = _bid_x*BLOCK_DIM_X + _tid_x;
...
template <class T>
void Add4(T *data, int nIters, T v) {
  int gid = _bid_x*BLOCK_DIM_X + _tid_x;
...
template <class T>
void Add8(T *data, int nIters, T v) {
  int gid = _bid_x*BLOCK_DIM_X + _tid_x;
...
template <class T>
void Mul1(T *data, int nIters, T v) {
  int gid = _bid_x*BLOCK_DIM_X + _tid_x;
...
template <class T>
void Mul2(T *data, int nIters, T v) {
  int gid = _bid_x*BLOCK_DIM_X + _tid_x;
...
template <class T>
void Mul4(T *data, int nIters, T v) {
  int gid = _bid_x*BLOCK_DIM_X + _tid_x;
...
template <class T>
void Mul8(T *data, int nIters, T v) {
  int gid = _bid_x*BLOCK_DIM_X + _tid_x;
...
template <class T>
void MAdd1(T *data, int nIters, T v1, T v2) {
  int gid = _bid_x*BLOCK_DIM_X + _tid_x;
  register T s = data[gid];
  for (int j=0 ; j<nIters ; ++j) {
     /* Each macro op has 20 operations.
...
template <class T>
void MAdd2(T *data, int nIters, T v1, T v2) {
  int gid = _bid_x*BLOCK_DIM_X + _tid_x;
  register T s = data[gid], s2=10.0f-s;
  for (int j=0 ; j<nIters ; ++j) {
     /* Each macro op has 20 operations.
...
template <class T>
void MAdd4(T *data, int nIters, T v1, T v2) {
  int gid = _bid_x*BLOCK_DIM_X + _tid_x;
  register T s = data[gid], s2=10.0f-s, s3=9.0f-s, s4=9.0f-s2;
  for (int j=0 ; j<nIters ; ++j) {
     /* Each macro op has 10 operations.
...
template <class T>
void MAdd8(T *data, int nIters, T v1, T v2) {
  int gid = _bid_x*BLOCK_DIM_X + _tid_x;
...
template <class T>
void MulMAdd1(T *data, int nIters, T v1, T v2) {
  int gid = _bid_x*BLOCK_DIM_X + _tid_x;
  register T s = data[gid];
  for (int j=0 ; j<nIters ; ++j) {
     /* Each macro op has 20 operations.
...
template <class T>
void MulMAdd2(T *data, int nIters, T v1, T v2) {
  int gid = _bid_x*BLOCK_DIM_X + _tid_x;
  register T s = data[gid], s2=10.0f-s;
  for (int j=0 ; j<nIters ; ++j) {
     /* Each macro op has 20 operations.
...
template <class T>
void MulMAdd4(T *data, int nIters, T v1, T v2) {
  int gid = _bid_x*BLOCK_DIM_X + _tid_x;
  register T s = data[gid], s2=10.0f-s, s3=9.0f-s, s4=9.0f-s2;
  for (int j=0 ; j<nIters ; ++j) {
     /* Each macro op has 10 operations.
...
template <class T>
void MulMAdd8(T *data, int nIters, T v1, T v2) {
  int gid = _bid_x*BLOCK_DIM_X + _tid_x;
  T s = data[gid], s2=10.0f-s, s3=9.0f-s, s4=9.0f-s2,
    s5=8.0f-s, s6=8.0f-s2, s7=7.0f-s, s8=7.0f-s2;
  for (int j=0 ; j<nIters ; ++j) {
