...
void init_facexy(
    ...
    P* facexy) 
{
    #pragma HLS INTERFACE s_axilite port=ix_base
    #pragma HLS INTERFACE s_axilite port=iy_base
    #pragma HLS INTERFACE s_axilite port=dims_b_ne
    #pragma HLS INTERFACE s_axilite port=dims_b_na
    #pragma HLS INTERFACE s_axilite port=dims_b_ncell_x
    #pragma HLS INTERFACE s_axilite port=dims_b_ncell_y
    #pragma HLS INTERFACE s_axilite port=dims_b_ncell_z
    #pragma HLS INTERFACE s_axilite port=dims_ncell_z
    #pragma HLS INTERFACE m_axi port=facexy offset=slave bundle=gmem0
                ...
                for (int _tid_y = 0; _tid_y < BLOCK_DIM_Y; _tid_y++) {
                    for (int _bid_x = 0; _bid_x < GRID_DIM_X; _bid_x++) {
                        ...
                        #pragma HLS PIPELINE II=1
                            ...
                            int ix = BLOCK_DIM_X * _bid_x + _tid_x;
                            int iy = BLOCK_DIM_Y * _bid_y + _tid_y;
                            int octant = BLOCK_DIM_Z * _bid_z + _tid_z;
    ...
    P* facexz) 
{
    ...
    #pragma HLS INTERFACE s_axilite port=dims_b_ncell_y
    #pragma HLS INTERFACE s_axilite port=dims_b_ncell_z
    #pragma HLS INTERFACE s_axilite port=proc_y_min
    #pragma HLS INTERFACE s_axilite port=proc_y_max
    #pragma HLS INTERFACE s_axilite port=stepinfoall
    #pragma HLS INTERFACE m_axi port=facexz offset=slave bundle=gmem0
    #pragma HLS INTERFACE s_axilite port=return
                ...
                for (int _tid_y = 0; _tid_y < BLOCK_DIM_Y; _tid_y++) {
                    for (int _bid_x = 0; _bid_x < GRID_DIM_X; _bid_x++) {
                        ...
                        #pragma HLS PIPELINE II=1
                            ...
                            int ix = BLOCK_DIM_X * _bid_x + _tid_x;
                            int iz = BLOCK_DIM_Y * _bid_y + _tid_y;
                            int octant = BLOCK_DIM_Z * _bid_z + _tid_z;
    ...
    P* faceyz)
{
    ...
    #pragma HLS INTERFACE s_axilite port=dims_b_ncell_y
    #pragma HLS INTERFACE s_axilite port=dims_b_ncell_z
    #pragma HLS INTERFACE s_axilite port=proc_x_min
    #pragma HLS INTERFACE s_axilite port=proc_x_max
    #pragma HLS INTERFACE s_axilite port=stepinfoall
    #pragma HLS INTERFACE m_axi port=faceyz offset=slave bundle=gmem0
    #pragma HLS INTERFACE s_axilite port=return
                ...
                for (int _tid_y = 0; _tid_y < BLOCK_DIM_Y; _tid_y++) {
                    for (int _bid_x = 0; _bid_x < GRID_DIM_X; _bid_x++) {
                        ...
                        #pragma HLS PIPELINE II=1
                            ...
                            int iy = BLOCK_DIM_X * _bid_x + _tid_x;
                            int iz = BLOCK_DIM_Y * _bid_y + _tid_y;
                            int octant = BLOCK_DIM_Z * _bid_z + _tid_z;
...
void wavefronts(
    ...
    P* vs_local)
{
    #pragma HLS INTERFACE s_axilite port=num_wavefronts
    #pragma HLS INTERFACE s_axilite port=ix_base
    #pragma HLS INTERFACE s_axilite port=iy_base
    #pragma HLS INTERFACE s_axilite port=v_b_size
    #pragma HLS INTERFACE s_axilite port=noctant_per_block
    #pragma HLS INTERFACE s_axilite port=dims_b
    #pragma HLS INTERFACE s_axilite port=stepinfoall
    #pragma HLS INTERFACE m_axi port=facexy offset=slave bundle=gmem0
    #pragma HLS INTERFACE m_axi port=facexz offset=slave bundle=gmem1
    #pragma HLS INTERFACE m_axi port=faceyz offset=slave bundle=gmem2
    #pragma HLS INTERFACE m_axi port=a_from_m offset=slave bundle=gmem3
    #pragma HLS INTERFACE m_axi port=m_from_a offset=slave bundle=gmem4
    #pragma HLS INTERFACE m_axi port=vi offset=slave bundle=gmem5
    #pragma HLS INTERFACE m_axi port=vo offset=slave bundle=gmem6
    #pragma HLS INTERFACE m_axi port=vs_local offset=slave bundle=gmem7
    #pragma HLS INTERFACE s_axilite port=return
                ...
                for (int _tid_y = 0; _tid_y < BLOCK_DIM_Y; _tid_y++) {
                    for (int _bid_x = 0; _bid_x < GRID_DIM_X; _bid_x++) {
                        ...
                        #pragma HLS PIPELINE II=1
                            ...
                            int octant = BLOCK_DIM_X * _bid_x + _tid_x;
                            int ie = BLOCK_DIM_Y * _bid_y + _tid_y;
