...
// --- from Filter.cu ---
extern "C"
void Short_to_Float(const short *imgNDVI, const unsigned char *imgQA,
                               int n_X, int n_Y, int n_B, int n_Years,
                               float * img_NDVI,
                               float * img_QA)
{
    #pragma HLS INTERFACE m_axi port=imgNDVI offset=slave bundle=gmem0
    #pragma HLS INTERFACE m_axi port=imgQA offset=slave bundle=gmem1
    #pragma HLS INTERFACE s_axilite port=n_X
    #pragma HLS INTERFACE s_axilite port=n_Y
    #pragma HLS INTERFACE s_axilite port=n_B
    #pragma HLS INTERFACE s_axilite port=n_Years
    #pragma HLS INTERFACE m_axi port=img_NDVI offset=slave bundle=gmem2
    #pragma HLS INTERFACE m_axi port=img_QA offset=slave bundle=gmem3
...
void Generate_NDVI_reference(float cosyear, int win_NDVI,
                                        const float * img_NDVI,
                                        const float * img_QA,
                                        int n_X, int n_Y, int n_B, int n_Years, 
                                        ...
                                        int * d_res_vec_res1)
{
    #pragma HLS INTERFACE s_axilite port=cosyear
    #pragma HLS INTERFACE s_axilite port=win_NDVI
    #pragma HLS INTERFACE m_axi port=img_NDVI offset=slave bundle=gmem0
    #pragma HLS INTERFACE m_axi port=img_QA offset=slave bundle=gmem1
    #pragma HLS INTERFACE s_axilite port=n_X
    #pragma HLS INTERFACE s_axilite port=n_Y
    #pragma HLS INTERFACE s_axilite port=n_B
    #pragma HLS INTERFACE s_axilite port=n_Years
    #pragma HLS INTERFACE m_axi port=reference_data offset=slave bundle=gmem2
    #pragma HLS INTERFACE m_axi port=d_res_3 offset=slave bundle=gmem3
    #pragma HLS INTERFACE m_axi port=d_res_vec_res1 offset=slave bundle=gmem4
    #pragma HLS INTERFACE s_axilite port=return
...
int StartY, int TotalY, int Buffer_Up, int Buffer_Dn, int n_X, int n_Y, int n_B, int n_Years, int win, float *d_res)
{
    ...
    #pragma HLS INTERFACE s_axilite port=TotalY
    #pragma HLS INTERFACE s_axilite port=Buffer_Up
    #pragma HLS INTERFACE s_axilite port=Buffer_Dn
    #pragma HLS INTERFACE s_axilite port=n_X
    #pragma HLS INTERFACE s_axilite port=n_Y
    #pragma HLS INTERFACE s_axilite port=n_B
    #pragma HLS INTERFACE s_axilite port=n_Years
    #pragma HLS INTERFACE s_axilite port=win
    #pragma HLS INTERFACE m_axi port=d_res offset=slave bundle=gmem3
    #pragma HLS INTERFACE s_axilite port=return
...
void STSG_filter(const float * img_NDVI,
                            const float * img_QA,
                            ...
                            int * d_index)
{
    ...
    #pragma HLS INTERFACE s_axilite port=n_Years
    #pragma HLS INTERFACE s_axilite port=win
    #pragma HLS INTERFACE s_axilite port=sampcorr
    #pragma HLS INTERFACE s_axilite port=snow_address
    #pragma HLS INTERFACE m_axi port=vector_out offset=slave bundle=gmem3
    #pragma HLS INTERFACE m_axi port=d_vector_in offset=slave bundle=gmem4
    #pragma HLS INTERFACE m_axi port=d_res offset=slave bundle=gmem5
    #pragma HLS INTERFACE m_axi port=d_res_3 offset=slave bundle=gmem6
    #pragma HLS INTERFACE m_axi port=d_index offset=slave bundle=gmem7
    #pragma HLS INTERFACE s_axilite port=return
