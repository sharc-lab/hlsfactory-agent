...
{
    #pragma HLS INTERFACE m_axi port=foundIndex offset=slave bundle=gmem0
    #pragma HLS INTERFACE m_axi port=foundKey offset=slave bundle=gmem1
    #pragma HLS INTERFACE m_axi port=foundDigest offset=slave bundle=gmem2
    #pragma HLS INTERFACE s_axilite port=keyspace
    #pragma HLS INTERFACE s_axilite port=byteLength
    #pragma HLS INTERFACE s_axilite port=valsPerByte
    #pragma HLS INTERFACE s_axilite port=searchDigest0
    #pragma HLS INTERFACE s_axilite port=searchDigest1
    #pragma HLS INTERFACE s_axilite port=searchDigest2
    #pragma HLS INTERFACE s_axilite port=searchDigest3
    ...
    for (int _bid_x = 0; _bid_x < GRID_DIM_X; _bid_x++) {
        ...
        #pragma HLS PIPELINE II=1
            ...
            int threadid = BLOCK_DIM_X * _bid_x + _tid_x;
