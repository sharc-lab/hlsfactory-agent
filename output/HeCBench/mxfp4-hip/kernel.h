...
// --- from common.h ---
// ROCm/HIP generally supports bfloat16 on modern GPUs
...
template <>
inline int bf16_or_half2int_rn(const __hip_bfloat16 h) {
  //return __bfloat2int_rn(h);
...
template <>
inline __hip_bfloat16 float_to_bf16_or_half(const float x) {
...
template <>
inline float bf16_or_half_to_float(const __hip_bfloat16 x) {
