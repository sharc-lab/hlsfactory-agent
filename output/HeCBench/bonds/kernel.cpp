...
dataType discountingBondEngineCalculateSettlementValueGpu(inArgsStruct inArgs, int bondNum, cashFlowsStruct cashFlows, int numLegs)  
{
...
dataType bondFunctionsAccruedAmountGpu(inArgsStruct inArgs, bondsDateStruct date, int bondNum, cashFlowsStruct cashFlows, int numLegs) 
{
...
dataType fixedRateCouponAccruedAmountGpu(cashFlowsStruct cashFlows, int numLeg, bondsDateStruct d, inArgsStruct inArgs, int bondNum) 
{
...
void bonds(inArgsStruct inArgs, resultsStruct results, int n)
{
    #pragma HLS INTERFACE s_axilite port=inArgs
    ...
    for (int _bid_x = 0; _bid_x < GRID_DIM_X; _bid_x++) {
        ...
        #pragma HLS PIPELINE II=1
            ...
            int bondNum = _bid_x*BLOCK_DIM_X + _tid_x;
            if (bondNum < n)
            {
            int numLegs;
