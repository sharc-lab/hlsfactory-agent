...
void ker_zmddft_fwd_256x256x256_cu0(const double *X, double *P1)
{
    ...
    #pragma HLS INTERFACE m_axi port=P1 offset=slave bundle=gmem1
    ...
    for (int _bid_x = 0; _bid_x < GRID_DIM_X; _bid_x++) {
        ...
        #pragma HLS PIPELINE II=1
            ...
            t1032 = (t994 - t1020);
            t1033 = (t995 - t1021);
            a1518 = ((8*_bid_x) + (131072*a1475) + (2*a1474));
...
{
    #pragma HLS INTERFACE m_axi port=P1 offset=slave bundle=gmem0
    #pragma HLS INTERFACE m_axi port=P2 offset=slave bundle=gmem1
    #pragma HLS INTERFACE s_axilite port=return
    #pragma HLS ARRAY_PARTITION variable=T3 complete dim=1
    #pragma HLS ARRAY_PARTITION variable=T33 complete dim=1
    ...
    for (int _bid_x = 0; _bid_x < GRID_DIM_X; _bid_x++) {
        ...
        #pragma HLS PIPELINE II=1
            ...
            a2009 = (512*(_tid_x / 16));
            a2010 = (_tid_x % 16);
            a2011 = ((2048*_bid_x) + a2009 + (2*a2010));
            s658 = P1[a2011];
            s659 = P1[(a2011 + 1)];
            s660 = P1[(a2011 + 256)];
            s661 = P1[(a2011 + 257)];
            ...
            t1896 = (t1858 - t1884);
            t1897 = (t1859 - t1885);
            a3035 = ((8*_bid_x) + (131072*a2992) + (2*a2991));
...
{
    #pragma HLS INTERFACE m_axi port=P2 offset=slave bundle=gmem0
    #pragma HLS INTERFACE m_axi port=Y offset=slave bundle=gmem1
    #pragma HLS INTERFACE s_axilite port=return
    #pragma HLS ARRAY_PARTITION variable=T63 complete dim=1
    ...
    for (int _bid_x = 0; _bid_x < GRID_DIM_X; _bid_x++) {
        ...
        #pragma HLS PIPELINE II=1
            ...
            a3526 = (512*(_tid_x / 16));
            a3527 = (_tid_x % 16);
            a3528 = ((2048*_bid_x) + a3526 + (2*a3527));
            s1170 = P2[a3528];
            s1171 = P2[(a3528 + 1)];
            s1172 = P2[(a3528 + 256)];
            s1173 = P2[(a3528 + 257)];
            ...
            t2760 = (t2722 - t2748);
            t2761 = (t2723 - t2749);
            a4552 = ((8*_bid_x) + (131072*a4509) + (2*a4508));
            Y[a4552] = (t2754 + t2758);
