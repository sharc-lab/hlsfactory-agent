...
void CanDeleteEdge(myInt *d_in_delete, myInt *isDecomposable) {
    #pragma HLS INTERFACE m_axi port=d_in_delete offset=slave bundle=gmem0
    #pragma HLS INTERFACE m_axi port=isDecomposable offset=slave bundle=gmem1
    ...
    for (int _bid_x = 0; _bid_x < GRID_DIM_X; _bid_x++) {
        ...
        #pragma HLS PIPELINE II=1
            ...
            myInt contain_a, contain_b, which_ab;
...
void CanAddEdge(myInt *d_in_delete, myInt *d_in_add,
                           myInt *isDecomposable) {
    #pragma HLS INTERFACE m_axi port=d_in_delete offset=slave bundle=gmem0
    #pragma HLS INTERFACE m_axi port=d_in_add offset=slave bundle=gmem1
    #pragma HLS INTERFACE m_axi port=isDecomposable offset=slave bundle=gmem2
    #pragma HLS INTERFACE s_axilite port=return
    #pragma HLS ARRAY_PARTITION variable=shmem complete dim=1
    ...
    for (int _bid_x = 0; _bid_x < GRID_DIM_X; _bid_x++) {
        ...
        #pragma HLS PIPELINE II=1
            ...
            myInt nS, pR, pT, contain_a, contain_b, aSi, bSi, common_parent, a,
            b;
            myBool flag;
            myInt *R;
            myInt *T;
