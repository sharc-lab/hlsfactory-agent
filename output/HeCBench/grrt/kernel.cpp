...
// --- from kernels.cu ---
static void rkstep(double* Variables, double* VariablesIn,double *y,
...
void task1(double* ResultsPixel,
                      double* VariablesIn,
                      int GridIdxX, int GridIdxY)
{
    #pragma HLS INTERFACE m_axi port=ResultsPixel offset=slave bundle=gmem0
    #pragma HLS INTERFACE m_axi port=VariablesIn offset=slave bundle=gmem1
    #pragma HLS INTERFACE s_axilite port=GridIdxX
    #pragma HLS INTERFACE s_axilite port=GridIdxY
...
void task2(double* ResultsPixel,
                      double* VariablesIn,
                      int GridIdxX, int GridIdxY)
{
    #pragma HLS INTERFACE m_axi port=ResultsPixel offset=slave bundle=gmem0
