...
template<>
inline float typeToFloat(__nv_bfloat16 a) {
...
template<>
inline __nv_bfloat16 floatToType(float a) {
...
template<>
inline __nv_bfloat162 floatToType2(float a) {
...
template<>
inline __nv_bfloat162 float2ToType2(float2 a) {
...
template<>
inline float2 type2ToFloat2(__nv_bfloat162 a) {
...
template<>
inline __nv_bfloat16 add(__nv_bfloat16 a, __nv_bfloat16 b) {
  return __hadd(a, b);
}
...
template<>
inline __nv_bfloat162 add(__nv_bfloat162 a, __nv_bfloat162 b, __nv_bfloat162 c) {
  return add(add(a, b), c);
}

template<>
inline __nv_bfloat16 add(__nv_bfloat16 a, __nv_bfloat16 b, __nv_bfloat16 c) {
  return add(add(a, b), c);
}
...
template<>
inline __nv_bfloat162 sub(__nv_bfloat162 a, __nv_bfloat162 b) {
  return __hsub2(a, b);
}
...
template<>
inline __nv_bfloat162 fma(__nv_bfloat162 a, __nv_bfloat162 b, __nv_bfloat162 c, __nv_bfloat162 d) {
    return __hadd2(__hmul2(__hmul2(a, b), c), d);
}
...
__inline__ T blockReduceSum(T val)
{
    ...
    val = (_tid_x < (BLOCK_DIM_X / 32)) ? shared[lane] : (T)(0.0f);
    val = warpReduceSum<T>(val);
