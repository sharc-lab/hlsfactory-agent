...
void getOutValOption(const optionInputStruct* options, float* outputVals, int numVals)
{
    #pragma HLS INTERFACE m_axi port=options offset=slave bundle=gmem0
    #pragma HLS INTERFACE m_axi port=outputVals offset=slave bundle=gmem1
    #pragma HLS INTERFACE s_axilite port=numVals
    ...
    for (int _bid_x = 0; _bid_x < GRID_DIM_X; _bid_x++) {
        ...
        #pragma HLS PIPELINE II=1
            ...
            int optionNum = _bid_x * BLOCK_DIM_X + _tid_x;
