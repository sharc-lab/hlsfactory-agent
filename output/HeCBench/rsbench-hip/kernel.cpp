...
void lookup ( 
    ...
    #pragma HLS INTERFACE m_axi port=verification offset=slave bundle=gmem3
    #pragma HLS INTERFACE m_axi port=n_windows offset=slave bundle=gmem4
    #pragma HLS INTERFACE m_axi port=pseudo_K0RS offset=slave bundle=gmem5
    #pragma HLS INTERFACE m_axi port=windows offset=slave bundle=gmem6
    #pragma HLS INTERFACE m_axi port=poles offset=slave bundle=gmem7
    #pragma HLS INTERFACE s_axilite port=n_lookups
    #pragma HLS INTERFACE s_axilite port=input_doppler
    #pragma HLS INTERFACE s_axilite port=input_numL
    #pragma HLS INTERFACE s_axilite port=max_num_windows
    #pragma HLS INTERFACE s_axilite port=max_num_poles
    ...
    for (int _bid_x = 0; _bid_x < GRID_DIM_X; _bid_x++) {
        ...
        #pragma HLS PIPELINE II=1
            ...
            size_t i = _tid_x + _bid_x * BLOCK_DIM_X;
