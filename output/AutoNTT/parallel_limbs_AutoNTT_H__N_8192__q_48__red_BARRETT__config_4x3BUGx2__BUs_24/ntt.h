...
const uint16_t V_BUG_SIZE = 4;
const uint16_t H_BUG_SIZE = 3;
const uint16_t logV_BUG_SIZE = 2;
const uint16_t BUG_CONCAT_FACTOR = 2;
const uint16_t logBUG_CONCAT_FACTOR = 1;
...
const uint8_t TF_PORTS_PER_PARA_LIMB=1;
