...
int main(int argc, char* argv[]) {
  ...
  kernel_time_ns = tapa::invoke(
      ...
      tapa::read_only_mmap<POLY_WIDE_DATA>(portWiseInPolyData[1]),
      ...
      tapa::write_only_mmap<POLY_WIDE_DATA>(portWiseOutData[1]),
  ...
  kernel_time_ns = tapa::invoke(
      ...
      tapa::read_only_mmap<POLY_WIDE_DATA>(inv_portWiseInPolyData[1]),
      ...
      tapa::write_only_mmap<POLY_WIDE_DATA>(inv_portWiseOutData[1]),
      workingModulus_arr[0],
      workingModulus_arr[1],
      workingModulus_arr[2],
      twoInverse_arr[0],
