...
//Poly
const uint16_t POLY_DRAM_PORT_WIDTH_PER_PARA_LIMB = 256;
...
//TFs
const uint16_t TF_DRAM_PORT_WIDTH_PER_PARA_LIMB = 256;
...
//TF Groups
const VAR_TYPE_16 FWD_NUM_TF_GRPS_PER_BUF[NUM_BU/2] = {2, 3, 3, 4, 3, 4, 4, 5};
const VAR_TYPE_16 INV_NUM_TF_GRPS_PER_BUF[NUM_BU/2] = {2, 4, 4, 6, 4, 6, 6, 8};
