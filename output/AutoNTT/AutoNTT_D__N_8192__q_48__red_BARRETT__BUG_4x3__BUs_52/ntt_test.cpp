...
int main(int argc, char* argv[]) {
  ...
  kernel_time_ns = tapa::invoke(
      ...
      tapa::read_write_mmap<POLY_WIDE_DATA>(portWiseInPolyData[1]),
      tapa::read_write_mmap<POLY_WIDE_DATA>(portWiseInPolyData[2]),
      ...
      tapa::read_only_mmap<TF_WIDE_DATA>(portWiseInTFData[5]),
      tapa::read_only_mmap<TF_WIDE_DATA>(portWiseInTFData[6]),
      tapa::read_only_mmap<TF_WIDE_DATA>(portWiseInTFData[7]),
      tapa::read_only_mmap<TF_WIDE_DATA>(portWiseInTFData[8]),
      tapa::read_only_mmap<TF_WIDE_DATA>(portWiseInTFData[9]),
      tapa::read_write_mmap<POLY_WIDE_DATA>(portWiseOutData[0]),
      tapa::read_write_mmap<POLY_WIDE_DATA>(portWiseOutData[1]),
      tapa::read_write_mmap<POLY_WIDE_DATA>(portWiseOutData[2]),
      workingModulus_arr[0],
      workingModulus_arr[1],
      workingModulus_arr[2],
      twoInverse_arr[0],
      twoInverse_arr[1],
      twoInverse_arr[2],
      factor[0],
  ...
  kernel_time_ns = tapa::invoke(
      ...
      tapa::read_write_mmap<POLY_WIDE_DATA>(inv_portWiseOutData[1]),
      tapa::read_write_mmap<POLY_WIDE_DATA>(inv_portWiseOutData[2]),
      ...
      tapa::read_only_mmap<TF_WIDE_DATA>(inv_portWiseInTFData[5]),
      tapa::read_only_mmap<TF_WIDE_DATA>(inv_portWiseInTFData[6]),
      tapa::read_only_mmap<TF_WIDE_DATA>(inv_portWiseInTFData[7]),
      tapa::read_only_mmap<TF_WIDE_DATA>(inv_portWiseInTFData[8]),
      tapa::read_only_mmap<TF_WIDE_DATA>(inv_portWiseInTFData[9]),
      tapa::read_write_mmap<POLY_WIDE_DATA>(portWiseOutData[0]),
      tapa::read_write_mmap<POLY_WIDE_DATA>(portWiseOutData[1]),
      tapa::read_write_mmap<POLY_WIDE_DATA>(portWiseOutData[2]),
      workingModulus_arr[0],
