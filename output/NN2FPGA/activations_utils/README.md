...
#pragma HLS stream, #pragma HLS array_partition, #pragma HLS dataflow, #pragma HLS pipeline, #pragma HLS inline

## Functions/Kernels

store_NCHW, stream_NHWC, rearrange_op, store_NHWC, stream_NCHW, arrange_op, concat_op, upsample_op
