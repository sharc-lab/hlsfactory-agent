/**
 * Testbench for k_gaussian_quadrature_a HLS kernel
 * SERI: Streaming Accelerator for Electron Repulsion Integrals
 * 
 * This testbench verifies the gaussian_quadrature_a kernel which computes
 * the first part of the Gaussian quadrature for ERI evaluation.
 */
...
int main() {
    std::cout << "========================================" << std::endl;
    std::cout << "k_gaussian_quadrature_a Testbench" << std::endl;
    std::cout << "========================================" << std::endl;
    ...
    std::cout << "Running k_gaussian_quadrature_a kernel..." << std::endl;

    // Call the kernel
#if BP_BYPASS == 0
    k_gaussian_quadrature_a(
    ...
    std::cout << std::endl;
    std::cout << "========================================" << std::endl;
    std::cout << "k_gaussian_quadrature_a testbench completed successfully!" << std::endl;
    std::cout << "========================================" << std::endl;
