...
### Function Signature
```cpp
void k_rr_b( hls::stream<D_WIDTH( xyz_derived_pt::bit_width )
```
...
```
k_rr_b/
├── k_rr_b.cpp          # Kernel source code
├── k_rr_b_tb.cpp       # Testbench
├── src/                        # Header files
...
```bash
clang++ -c -std=c++17 -I./stubs -I./src/common -I./src/device k_rr_b.cpp
```
