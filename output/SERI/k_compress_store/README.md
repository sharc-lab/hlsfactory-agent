...
### Function Signature
```cpp
void k_compress_store( hls::stream<D_WIDTH( ba_cart_eris_pt::bit_width / 2 )
```

### Arguments
- `cart_eris_stream_in_1`: Stream interface
- `b_max_stream_in`: Stream interface
- `cart_eris_stream_in_0`: Stream interface

## File Structure

```
k_compress_store/
├── k_compress_store.cpp          # Kernel source code
├── k_compress_store_tb.cpp       # Testbench
├── src/                        # Header files
...
```bash
clang++ -c -std=c++17 -I./stubs -I./src/common -I./src/device k_compress_store.cpp
```
