/**
 * Testbench for k_rr_a HLS kernel
 * SERI: Streaming Accelerator for Electron Repulsion Integrals
 * 
 * This testbench verifies the k_rr_a kernel which is the first part
...
int main() {
    std::cout << "========================================" << std::endl;
    std::cout << "k_rr_a Testbench" << std::endl;
    std::cout << "========================================" << std::endl;
    ...
    std::cout << "Running k_rr_a kernel..." << std::endl;

    // Call the kernel
    k_rr_a(
        xyz_derived_stream_in, rys_wt_stream_in, tb_b_stream_in, tb_c_stream_in,
        xyz_derived_stream_out, rys_wt_stream_out, tb_b_stream_out, tb_c_stream_out,
        ucba_stream_out_0, n_stream_in, n_stream_out
    );
    ...
    std::cout << std::endl;
    std::cout << "========================================" << std::endl;
    std::cout << "k_rr_a testbench completed successfully!" << std::endl;
    std::cout << "========================================" << std::endl;
