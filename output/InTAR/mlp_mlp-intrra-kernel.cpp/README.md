# MLP - Mlp-Intrra-Kernel.Cpp Variant

## Overview
This is an HLS design from the InTAR repository implementing mlp.

## Design Details
- **Name**: mlp
- **Variant**: mlp-intrra-kernel.cpp
- **Source**: /workspace/repo/benchmark/mlp/mlp-intrra-kernel.cpp
