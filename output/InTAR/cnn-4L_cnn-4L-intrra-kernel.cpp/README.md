# CNN-4L - Cnn-4L-Intrra-Kernel.Cpp Variant

## Overview
This is an HLS design from the InTAR repository implementing cnn-4L.

## Design Details
- **Name**: cnn-4L
- **Variant**: cnn-4L-intrra-kernel.cpp
- **Source**: /workspace/repo/benchmark/cnn-4L/cnn-4L-intrra-kernel.cpp
