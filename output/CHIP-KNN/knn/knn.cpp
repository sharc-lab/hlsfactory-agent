...
void Knn(
    ...
    tapa::streams<DATA_TYPE, 1> L0_out_dist;
    tapa::streams<int,       1> L0_out_id;
    // Streams, for load->compute->sort:
    tapa::streams<INTERFACE_WIDTH, NUM_PE>           load_to_compute_stream;
    tapa::streams<LOCAL_DIST_DTYPE, NUM_SEGMENTS>    compute_to_sort_stream_0;
    tapa::streams<DATA_TYPE, NUM_SEGMENTS*D2L_FACTOR_W>                 sort_to_hiermerge_dist_stream_0;
    tapa::streams<int, NUM_SEGMENTS*D2L_FACTOR_W>                       sort_to_hiermerge_id_stream_0;
