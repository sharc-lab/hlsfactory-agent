/**
 * Testbench for CHIP-KNN Multi PE Design
 * 
 * This testbench verifies the K-Nearest Neighbors accelerator
 * with multiple Processing Elements (PEs) for parallel processing.
 */
...
int main() {
    printf("========================================\n");
    printf("CHIP-KNN Multi PE Testbench\n");
    printf("========================================\n");
    ...
    printf("Multi-PE design provides %dx parallelism for higher throughput.\n", NUM_PE);
