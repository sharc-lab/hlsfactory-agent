...
void Knn(
    ...
    tapa::streams<DATA_TYPE, 4, TOP> L0_out_dist;
    tapa::streams<int,       4, TOP> L0_out_id;
    tapa::streams<DATA_TYPE, 2, 2>   L1_out_dist;
    tapa::streams<int,       2, 2>   L1_out_id;
    ...
    tapa::task()
        ...
        .invoke( merge_dual_streams_FINAL, -1, 0, 0, L1_out_dist[0], L1_out_id[0], L1_out_dist[1], L1_out_id[1], final_out);
}
