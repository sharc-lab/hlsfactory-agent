                ...
                int border)
{
    ...
    #pragma HLS INTERFACE m_axi port=gpuResults offset=slave bundle=gmem2
    #pragma HLS INTERFACE s_axilite port=cols
    #pragma HLS INTERFACE s_axilite port=rows
    #pragma HLS INTERFACE s_axilite port=startStep
    #pragma HLS INTERFACE s_axilite port=border
