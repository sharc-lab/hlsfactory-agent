...
// --- from embedded_fehlberg_7_8_2.cu ---
void embedded_fehlberg_7_8_2(	fp h,
...
// --- from kernel.cu ---
extern "C"
void kernel(	int timeinst,
										fp* d_initvalu,
										fp* d_finavalu,
										fp* d_params,
										fp* d_com){
    #pragma HLS INTERFACE s_axilite port=timeinst
    #pragma HLS INTERFACE m_axi port=d_initvalu offset=slave bundle=gmem0
    #pragma HLS INTERFACE m_axi port=d_finavalu offset=slave bundle=gmem1
    #pragma HLS INTERFACE m_axi port=d_params offset=slave bundle=gmem2
    #pragma HLS INTERFACE m_axi port=d_com offset=slave bundle=gmem3
    ...
    for (int _bid_x = 0; _bid_x < GRID_DIM_X; _bid_x++) {
        ...
        #pragma HLS PIPELINE II=1
            ...
            // CUDA indexes
            bx = _bid_x;																// get current horizontal block index (0-n)
            tx = _tid_x;																// get current horizontal thread index (0-n)
...
// --- from kernel_cam_2.cu ---
void kernel_cam_2(	fp timeinst,
													fp* d_initvalu,
													fp *d_finavalu,
													int valu_offset,
													fp* d_params,
...
// --- from kernel_ecc_2.cu ---
void kernel_ecc_2(	fp timeinst,
													fp* d_initvalu,
													fp* d_finavalu,
													int valu_offset,
													fp* d_params){
...
// --- from kernel_fin_2.cu ---
void kernel_fin_2(	int timeinst,
													fp* d_initvalu,
													fp* d_finavalu,
													int offset_ecc,
													int offset_Dyad,
...
void solver_2(	int workload,
											...
											fp* initvalu_temp,
											fp* finavalu_temp){
    #pragma HLS INTERFACE s_axilite port=workload
    ...
    #pragma HLS INTERFACE m_axi port=com offset=slave bundle=gmem3
    #pragma HLS INTERFACE m_axi port=err offset=slave bundle=gmem4
    #pragma HLS INTERFACE m_axi port=scale offset=slave bundle=gmem5
    #pragma HLS INTERFACE m_axi port=yy offset=slave bundle=gmem6
    #pragma HLS INTERFACE m_axi port=initvalu_temp offset=slave bundle=gmem7
    #pragma HLS INTERFACE m_axi port=finavalu_temp offset=slave bundle=gmem8
    #pragma HLS INTERFACE s_axilite port=return
