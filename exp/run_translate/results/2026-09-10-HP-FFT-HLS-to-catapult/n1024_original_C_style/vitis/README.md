# HP-FFT-HLS: n1024_original_C_style
...
Original C-style FFT implementation without pipelining or explicit loop unrolling. The FFT is computed sequentially stage by stage.
