# HP-FFT-HLS: n1024_no_StagePipeline
...
FFT with temporal double-buffering but without fine-grained stage-level pipelining. Uses FFT_stage_temporal with dataflow across stages.

## Top-Level Function
`FFT_TOP`

## Interface
Array-based (complex<float> dataIn[FFT_NUM], complex<float> dataOut[FFT_NUM])
