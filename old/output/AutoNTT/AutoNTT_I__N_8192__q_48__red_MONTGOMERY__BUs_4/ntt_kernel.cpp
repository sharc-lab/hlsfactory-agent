...
ap_uint<48> hardcoded_lowerHalfMul_96x48(ap_uint<96> u, ap_uint<48> v){
  #pragma HLS inline
  ...
  u = u >> 17;
  ap_uint<17> u_3 = u & ((1<<17)-1);
  u = u >> 17;
  ap_uint<17> u_4 = u & ((1<<17)-1);
  u = u >> 17;
  ap_uint<11> u_5 = u & ((1<<11)-1);
  ...
  ap_uint<38> mul_6 = ((ap_uint<38>)(u_0) * v_1); //<<27
  #pragma HLS bind_op variable=mul_6 op=mul impl=dsp
  ap_uint<38> mul_7 = ((ap_uint<38>)(u_1) * v_1); //<<44
  #pragma HLS bind_op variable=mul_7 op=mul impl=dsp

  
  ap_uint<48> res = ( (((ap_uint<48>)mul_0)<<0) + (((ap_uint<48>)mul_1)<<17) + (((ap_uint<48>)mul_2)<<34) + (((ap_uint<48>)mul_6)<<27) + (((ap_uint<48>)mul_7)<<44) ) & WORD_SIZE_MASK;
  return res;
}

WORD montgomery_reduce(WORD u, WORD v, WORD q, WORD k) 
{
  #pragma HLS inline
  ...
  TWORD uv_mul_k;
  WORD s = hardcoded_lowerHalfMul_96x48(product_uv,k);

  DWORD s_mul_mod;
  // #pragma HLS bind_op variable=s_mul_mod op=mul impl=dsp latency=0
  s_mul_mod = hardcoded_fullMul_48x48(s,q);

  DWORD_PLUS1 s_mul_mod_add_uv = product_uv + s_mul_mod;

  WORD_PLUS1 t = (WORD_PLUS1)(s_mul_mod_add_uv >> WORD_SIZE);  // shift_montgomery = n

	WORD res = ((WORD_PLUS1)(t) < (WORD_PLUS1)(q)) ? (WORD)(t) : (WORD)((WORD_PLUS1)(t) - (WORD_PLUS1)(q));
  return res; //convert_out(res, r_inverse, mod);
}
...
void BU(
  ...
  BU_COMP:for (;i<numBUIter; ) {
    ...
    if((((!fwd_inVal0.empty()) && (!fwd_inVal1.empty())) || ((!inv_inVals[0].empty()) && (!inv_inVals[1].empty())))  && (!inTf.empty())){
      ...
      WORD reducedProduct = montgomery_reduce(right, tfVal, q, k);
    ...
    )
{
    ...
    tapa::task()
        ...
        //BU tasks
        .invoke(BU, fwd_polyBuf_to_BU_L0_0[0], fwd_polyBuf_to_BU_L0_2[0], inv_polyBuf_to_BU_L0_0, tfBuf_to_BU_L0_0[0], fwd_BU_to_polyBuf_L0_0, inv_BU_to_polyBuf_L0_0[0], inv_BU_to_polyBuf_L0_2[0], q0, twoInverse0, k0, direction, iter, 0)
        .invoke(BU, fwd_polyBuf_to_BU_L0_0[1], fwd_polyBuf_to_BU_L0_2[1], inv_polyBuf_to_BU_L0_1, tfBuf_to_BU_L0_1[0], fwd_BU_to_polyBuf_L0_1, inv_BU_to_polyBuf_L0_0[1], inv_BU_to_polyBuf_L0_2[1], q0, twoInverse0, k0, direction, iter, 1)
        .invoke(BU, fwd_polyBuf_to_BU_L0_1[0], fwd_polyBuf_to_BU_L0_3[0], inv_polyBuf_to_BU_L0_2, tfBuf_to_BU_L0_0[1], fwd_BU_to_polyBuf_L0_2, inv_BU_to_polyBuf_L0_1[0], inv_BU_to_polyBuf_L0_3[0], q0, twoInverse0, k0, direction, iter, 2)
        .invoke(BU, fwd_polyBuf_to_BU_L0_1[1], fwd_polyBuf_to_BU_L0_3[1], inv_polyBuf_to_BU_L0_3, tfBuf_to_BU_L0_1[1], fwd_BU_to_polyBuf_L0_3, inv_BU_to_polyBuf_L0_1[1], inv_BU_to_polyBuf_L0_3[1], q0, twoInverse0, k0, direction, iter, 3)
