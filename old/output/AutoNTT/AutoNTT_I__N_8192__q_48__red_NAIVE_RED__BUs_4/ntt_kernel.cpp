...
WORD naive_reduce(WORD u, WORD v, WORD mod)
{
  #pragma HLS inline

  DWORD U = hardcoded_fullMul_0(u,v);
  WORD result = (WORD)(U % (DWORD)mod);
	return (WORD)result;
}
...
void BU(
  ...
  BU_COMP:for (;i<numBUIter; ) {
    ...
    if((((!fwd_inVal0.empty()) && (!fwd_inVal1.empty())) || ((!inv_inVals[0].empty()) && (!inv_inVals[1].empty())))  && (!inTf.empty())){
      ...
      WORD reducedProduct = naive_reduce(right, tfVal, q);
    ...
    )
{
    ...
    tapa::task()
        ...
        //BU tasks
        .invoke(BU, fwd_polyBuf_to_BU_L0_0[0], fwd_polyBuf_to_BU_L0_2[0], inv_polyBuf_to_BU_L0_0, tfBuf_to_BU_L0_0[0], fwd_BU_to_polyBuf_L0_0, inv_BU_to_polyBuf_L0_0[0], inv_BU_to_polyBuf_L0_2[0], q0, twoInverse0, direction, iter, 0)
        .invoke(BU, fwd_polyBuf_to_BU_L0_0[1], fwd_polyBuf_to_BU_L0_2[1], inv_polyBuf_to_BU_L0_1, tfBuf_to_BU_L0_1[0], fwd_BU_to_polyBuf_L0_1, inv_BU_to_polyBuf_L0_0[1], inv_BU_to_polyBuf_L0_2[1], q0, twoInverse0, direction, iter, 1)
        .invoke(BU, fwd_polyBuf_to_BU_L0_1[0], fwd_polyBuf_to_BU_L0_3[0], inv_polyBuf_to_BU_L0_2, tfBuf_to_BU_L0_0[1], fwd_BU_to_polyBuf_L0_2, inv_BU_to_polyBuf_L0_1[0], inv_BU_to_polyBuf_L0_3[0], q0, twoInverse0, direction, iter, 2)
        .invoke(BU, fwd_polyBuf_to_BU_L0_1[1], fwd_polyBuf_to_BU_L0_3[1], inv_polyBuf_to_BU_L0_3, tfBuf_to_BU_L0_1[1], fwd_BU_to_polyBuf_L0_3, inv_BU_to_polyBuf_L0_1[1], inv_BU_to_polyBuf_L0_3[1], q0, twoInverse0, direction, iter, 3)
